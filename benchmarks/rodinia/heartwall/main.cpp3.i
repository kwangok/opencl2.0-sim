...
# 35 "main.cu"
static __attribute__((__used__)) __attribute__((constant)) params_common_change d_common_change;
# 38 "main.cu"
static __attribute__((__used__)) __attribute__((constant)) params_common d_common;
# 41 "main.cu"
static __attribute__((__used__)) __attribute__((constant)) params_unique d_unique[51];
