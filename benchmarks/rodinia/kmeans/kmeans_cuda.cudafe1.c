...
float *feature_d = 0;
float *feature_flipped_d = 0;
int *membership_d = 0;
float *block_new_centers = 0;
float *clusters_d = 0;
float *block_clusters_d = 0;
int *block_deltas_d = 0;
...
cudaMalloc(((void **)(&feature_flipped_d)), (((unsigned long)(npoints * nfeatures)) * 4UL));
cudaMemcpy(((void *)feature_flipped_d), ((const void *)(features[0])), (((unsigned long)(npoints * nfeatures)) * 4UL), cudaMemcpyHostToDevice);
cudaMalloc(((void **)(&feature_d)), (((unsigned long)(npoints * nfeatures)) * 4UL));


(cudaConfigureCall((((void)((__T21 = num_blocks) , (void)((((__T20.x) = __T21) , (void)((__T20.y) = 1U)) , ((__T20.z) = 1U)))) , __T20), (((void)((__T23 = num_threads) , (void)((((__T22.x) = __T23) , (void)((__T22.y) = 1U)) , ((__T22.z) = 1U)))) , __T22), 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z14invert_mappingPfS_ii(feature_flipped_d, feature_d, npoints, nfeatures));


cudaMalloc(((void **)(&membership_d)), (((unsigned long)npoints) * 4UL));
cudaMalloc(((void **)(&clusters_d)), (((unsigned long)(nclusters * nfeatures)) * 4UL)); 
# 96 "kmeans_cuda.cu"
}
...
cudaFree(((void *)feature_d));
cudaFree(((void *)feature_flipped_d));
cudaFree(((void *)membership_d));

cudaFree(((void *)clusters_d)); 
# 117 "kmeans_cuda.cu"
}
# 126 "kmeans_cuda.cu"
...
{  unsigned __T24;
 ...
 unsigned __T26;
# 151 "kmeans_cuda.cu"
 int __cuda_local_var_17712_6_non_const_delta;
 int __cuda_local_var_17713_6_non_const_i;
# 152 "kmeans_cuda.cu"
 int __cuda_local_var_17713_8_non_const_j;
# 194 "kmeans_cuda.cu"
 dim3 __cuda_local_var_17724_10_non_const_grid;
 dim3 __cuda_local_var_17725_10_non_const_threads;
# 151 "kmeans_cuda.cu"
__cuda_local_var_17712_6_non_const_delta = 0;
# 158 "kmeans_cuda.cu"
cudaMemcpy(((void *)membership_d), ((const void *)membership_new), (((unsigned long)npoints) * 4UL), cudaMemcpyHostToDevice);


cudaMemcpy(((void *)clusters_d), ((const void *)(clusters[0])), (((unsigned long)(nclusters * nfeatures)) * 4UL), cudaMemcpyHostToDevice);
# 194 "kmeans_cuda.cu"
{ __T24 = num_blocks_perdim; __T25 = num_blocks_perdim; { (__cuda_local_var_17724_10_non_const_grid.x) = __T24; (__cuda_local_var_17724_10_non_const_grid.y) = __T25; (__cuda_local_var_17724_10_non_const_grid.z) = 1U; } }
{ __T26 = (num_threads_perdim * num_threads_perdim); { (__cuda_local_var_17725_10_non_const_threads.x) = __T26; (__cuda_local_var_17725_10_non_const_threads.y) = 1U; (__cuda_local_var_17725_10_non_const_threads.z) = 1U; } }


(cudaConfigureCall(__cuda_local_var_17724_10_non_const_grid, __cuda_local_var_17725_10_non_const_threads, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z11kmeansPointPfiiiPiS_S_S0_(feature_d, nfeatures, npoints, nclusters, membership_d, clusters_d, block_clusters_d, block_deltas_d));
# 207 "kmeans_cuda.cu"
cudaThreadSynchronize();


cudaMemcpy(((void *)membership_new), ((const void *)membership_d), (((unsigned long)npoints) * 4UL), cudaMemcpyDeviceToHost);
# 236 "kmeans_cuda.cu"
__cuda_local_var_17712_6_non_const_delta = 0;
for (__cuda_local_var_17713_6_non_const_i = 0; (__cuda_local_var_17713_6_non_const_i < npoints); __cuda_local_var_17713_6_non_const_i++)
{
 int __cuda_local_var_17745_7_non_const_cluster_id;
# 239 "kmeans_cuda.cu"
__cuda_local_var_17745_7_non_const_cluster_id = (membership_new[__cuda_local_var_17713_6_non_const_i]);
(new_centers_len[__cuda_local_var_17745_7_non_const_cluster_id])++;
if ((membership_new[__cuda_local_var_17713_6_non_const_i]) != (membership[__cuda_local_var_17713_6_non_const_i]))
{

__cuda_local_var_17712_6_non_const_delta++;

(membership[__cuda_local_var_17713_6_non_const_i]) = (membership_new[__cuda_local_var_17713_6_non_const_i]);
}

for (__cuda_local_var_17713_8_non_const_j = 0; (__cuda_local_var_17713_8_non_const_j < nfeatures); __cuda_local_var_17713_8_non_const_j++)
{
((new_centers[__cuda_local_var_17745_7_non_const_cluster_id])[__cuda_local_var_17713_8_non_const_j]) += ((feature[__cuda_local_var_17713_6_non_const_i])[__cuda_local_var_17713_8_non_const_j]);
}

}
# 305 "kmeans_cuda.cu"
return __cuda_local_var_17712_6_non_const_delta;
