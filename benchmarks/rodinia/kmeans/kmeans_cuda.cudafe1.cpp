...
# 85
 __attribute((__noreturn__)); 
# 38 "/usr/lib/gcc/x86_64-linux-gnu/4.4.7/include/omp.h" 3
typedef 
# 35
struct { 
# 36
...
# 63
extern "C" int omp_get_num_threads() throw(); 
# 64
extern "C" int omp_get_max_threads() throw(); 
# 65
extern "C" int omp_get_thread_num() throw(); 
# 66
extern "C" int omp_get_num_procs() throw(); 
# 68
extern "C" int omp_in_parallel() throw(); 
# 70
extern "C" void omp_set_dynamic(int) throw(); 
# 71
extern "C" int omp_get_dynamic() throw(); 
# 73
extern "C" void omp_set_nested(int) throw(); 
# 74
extern "C" int omp_get_nested() throw(); 
# 76
extern "C" void omp_init_lock(omp_lock_t *) throw(); 
# 77
extern "C" void omp_destroy_lock(omp_lock_t *) throw(); 
# 78
extern "C" void omp_set_lock(omp_lock_t *) throw(); 
# 79
extern "C" void omp_unset_lock(omp_lock_t *) throw(); 
# 80
extern "C" int omp_test_lock(omp_lock_t *) throw(); 
# 82
extern "C" void omp_init_nest_lock(omp_nest_lock_t *) throw(); 
# 83
extern "C" void omp_destroy_nest_lock(omp_nest_lock_t *) throw(); 
# 84
extern "C" void omp_set_nest_lock(omp_nest_lock_t *) throw(); 
# 85
extern "C" void omp_unset_nest_lock(omp_nest_lock_t *) throw(); 
# 86
extern "C" int omp_test_nest_lock(omp_nest_lock_t *) throw(); 
# 88
extern "C" double omp_get_wtime() throw(); 
# 89
extern "C" double omp_get_wtick() throw(); 
# 91
extern "C" void omp_set_schedule(omp_sched_t, int) throw(); 
# 92
extern "C" void omp_get_schedule(omp_sched_t *, int *) throw(); 
# 93
extern "C" int omp_get_thread_limit() throw(); 
# 94
extern "C" void omp_set_max_active_levels(int) throw(); 
# 95
extern "C" int omp_get_max_active_levels() throw(); 
# 96
extern "C" int omp_get_level() throw(); 
# 97
extern "C" int omp_get_ancestor_thread_num(int) throw(); 
# 98
extern "C" int omp_get_team_size(int) throw(); 
# 99
extern "C" int omp_get_active_level() throw(); 
...
void invert_mapping(float *input, float *
# 35
output, int 
# 36
npoints, int 
...
void kmeansPoint(float *features, int 
# 59
nfeatures, int 
# 60
npoints, int 
...
{ 
# 69
const unsigned block_id = (((gridDim.x) * (blockIdx.y)) + (blockIdx.x)); 
# 71
const unsigned point_id = (((block_id * (blockDim.x)) * (blockDim.y)) + (threadIdx.x)); 
# 73
int index = (-1); 
# 75
if (point_id < npoints) 
...
int i, j; 
# 78
float min_dist = ((3.402823469999999844e+38)); 
# 79
float dist; 
# 82
...
# 28
unsigned num_threads_perdim = (16); 
# 29
unsigned num_blocks_perdim = (16); 
# 30
unsigned num_threads = (num_threads_perdim * num_threads_perdim); 
# 31
unsigned num_blocks = (num_blocks_perdim * num_blocks_perdim); 
# 34
int *membership_new; 
# 35
float *feature_d; 
...
# 74
cudaConfigureCall(num_blocks, num_threads) ? ((void)0) : invert_mapping(feature_flipped_d, feature_d, npoints, nfeatures); 
# 77
...
# 141
extern "C" int kmeansCuda(float **feature, int 
# 142
nfeatures, int 
# 143
npoints, int 
...
# 198
cudaConfigureCall(grid, threads) ? ((void)0) : kmeansPoint(feature_d, nfeatures, npoints, nclusters, membership_d, clusters_d, block_clusters_d, block_deltas_d); 
# 207
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_kmeans_cuda_cpp4_ii_68086035
# 1 "kmeans_cuda.cudafe1.stub.c"
