...
# 204
cudaConfigureCall(grid, threads, 0) ? ((void)0) : Kernel(d_graph_nodes, d_graph_edges, d_graph_mask, d_updating_graph_mask, d_graph_visited, d_cost, no_of_nodes); 
# 208
cudaConfigureCall(grid, threads, 0) ? ((void)0) : Kernel2(d_graph_mask, d_updating_graph_mask, d_graph_visited, d_over, no_of_nodes); 
# 212
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__11_bfs_cpp4_ii_ad18112b
# 1 "bfs.cudafe1.stub.c"
