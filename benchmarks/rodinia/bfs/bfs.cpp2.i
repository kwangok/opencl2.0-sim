...
# 1048 "/home/bachelor/deicide218/cuda-4.2/include/math_functions.h"
 __attribute__((device_builtin)) extern __attribute__((device)) __attribute__((__const__)) double ceil(double);
...
# 22 "./kernel.cu"
__attribute__((global)) extern void _Z6KernelP4NodePiPbS2_S2_S1_i(struct Node *, int *, __nv_bool *, __nv_bool *, __nv_bool *, int *, int);
# 22 "./kernel2.cu"
__attribute__((global)) extern void _Z7Kernel2PbS_S_S_i(__nv_bool *, __nv_bool *, __nv_bool *, __nv_bool *, int);
...
# 24 "./kernel2.cu" 2
# 22 "./kernel.cu"
__attribute__((global)) void _Z6KernelP4NodePiPbS2_S2_S1_i(
# 22 "./kernel.cu"
...
# 22 "./kernel2.cu"
__attribute__((global)) void _Z7Kernel2PbS_S_S_i(
# 22 "./kernel2.cu"
__nv_bool *g_graph_mask,
# 22 "./kernel2.cu"
__nv_bool *g_updating_graph_mask,
