...
# 145 "bfs.cu"
 struct Node *__cuda_local_var_17627_8_non_const_d_graph_nodes;




 int *__cuda_local_var_17632_7_non_const_d_graph_edges;




 char *__cuda_local_var_17637_8_non_const_d_graph_mask;



 char *__cuda_local_var_17641_8_non_const_d_updating_graph_mask;




 char *__cuda_local_var_17646_8_non_const_d_graph_visited;




 int *__cuda_local_var_17651_7_non_const_h_cost;





 int *__cuda_local_var_17657_7_non_const_d_cost;



 char *__cuda_local_var_17661_8_non_const_d_over;
# 192 "bfs.cu"
 dim3 __cuda_local_var_17674_7_non_const_grid;
 dim3 __cuda_local_var_17675_7_non_const_threads;

 int __cuda_local_var_17677_6_non_const_k;

 char __cuda_local_var_17679_7_non_const_stop;
# 229 "bfs.cu"
 FILE *__cuda_local_var_17711_8_non_const_fpo;
# 72 "bfs.cu"
if (argc != 2) {
...
cudaMalloc(((void **)(&__cuda_local_var_17627_8_non_const_d_graph_nodes)), (8UL * ((unsigned long)no_of_nodes)));
cudaMemcpy(((void *)__cuda_local_var_17627_8_non_const_d_graph_nodes), ((const void *)__cuda_local_var_17585_8_non_const_h_graph_nodes), (8UL * ((unsigned long)no_of_nodes)), cudaMemcpyHostToDevice);



cudaMalloc(((void **)(&__cuda_local_var_17632_7_non_const_d_graph_edges)), (4UL * ((unsigned long)edge_list_size)));
cudaMemcpy(((void *)__cuda_local_var_17632_7_non_const_d_graph_edges), ((const void *)__cuda_local_var_17613_7_non_const_h_graph_edges), (4UL * ((unsigned long)edge_list_size)), cudaMemcpyHostToDevice);



cudaMalloc(((void **)(&__cuda_local_var_17637_8_non_const_d_graph_mask)), (1UL * ((unsigned long)no_of_nodes)));
cudaMemcpy(((void *)__cuda_local_var_17637_8_non_const_d_graph_mask), ((const void *)__cuda_local_var_17586_8_non_const_h_graph_mask), (1UL * ((unsigned long)no_of_nodes)), cudaMemcpyHostToDevice);


cudaMalloc(((void **)(&__cuda_local_var_17641_8_non_const_d_updating_graph_mask)), (1UL * ((unsigned long)no_of_nodes)));
cudaMemcpy(((void *)__cuda_local_var_17641_8_non_const_d_updating_graph_mask), ((const void *)__cuda_local_var_17587_8_non_const_h_updating_graph_mask), (1UL * ((unsigned long)no_of_nodes)), cudaMemcpyHostToDevice);



cudaMalloc(((void **)(&__cuda_local_var_17646_8_non_const_d_graph_visited)), (1UL * ((unsigned long)no_of_nodes)));
cudaMemcpy(((void *)__cuda_local_var_17646_8_non_const_d_graph_visited), ((const void *)__cuda_local_var_17588_8_non_const_h_graph_visited), (1UL * ((unsigned long)no_of_nodes)), cudaMemcpyHostToDevice);


__cuda_local_var_17651_7_non_const_h_cost = ((int *)(malloc((4UL * ((unsigned long)no_of_nodes))))); {
 int i;
# 170 "bfs.cu"
i = 0; for (; (i < no_of_nodes); i++) {
(__cuda_local_var_17651_7_non_const_h_cost[i]) = (-1); } }
(__cuda_local_var_17651_7_non_const_h_cost[__cuda_local_var_17569_6_non_const_source]) = 0;



cudaMalloc(((void **)(&__cuda_local_var_17657_7_non_const_d_cost)), (4UL * ((unsigned long)no_of_nodes)));



cudaMalloc(((void **)(&__cuda_local_var_17661_8_non_const_d_over)), 1UL);
...
cudaMemcpy(((void *)__cuda_local_var_17657_7_non_const_d_cost), ((const void *)__cuda_local_var_17651_7_non_const_h_cost), (4UL * ((unsigned long)no_of_nodes)), cudaMemcpyHostToDevice);

printf(((const char *)"Copied Everything to GPU memory\n"));


{ __T20 = ((unsigned)__cuda_local_var_17573_6_non_const_num_of_blocks); { (__cuda_local_var_17674_7_non_const_grid.x) = __T20; (__cuda_local_var_17674_7_non_const_grid.y) = 1U; (__cuda_local_var_17674_7_non_const_grid.z) = 1U; } }
{ __T21 = ((unsigned)__cuda_local_var_17574_6_non_const_num_of_threads_per_block); { (__cuda_local_var_17675_7_non_const_threads.x) = __T21; (__cuda_local_var_17675_7_non_const_threads.y) = 1U; (__cuda_local_var_17675_7_non_const_threads.z) = 1U; } }

__cuda_local_var_17677_6_non_const_k = 0;
...
__cuda_local_var_17679_7_non_const_stop = ((char)0);
cudaMemcpy(((void *)__cuda_local_var_17661_8_non_const_d_over), ((const void *)(&__cuda_local_var_17679_7_non_const_stop)), 1UL, cudaMemcpyHostToDevice);
(cudaConfigureCall(__cuda_local_var_17674_7_non_const_grid, __cuda_local_var_17675_7_non_const_threads, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z6KernelP4NodePiPbS2_S2_S1_i(__cuda_local_var_17627_8_non_const_d_graph_nodes, __cuda_local_var_17632_7_non_const_d_graph_edges, __cuda_local_var_17637_8_non_const_d_graph_mask, __cuda_local_var_17641_8_non_const_d_updating_graph_mask, __cuda_local_var_17646_8_non_const_d_graph_visited, __cuda_local_var_17657_7_non_const_d_cost, no_of_nodes));



(cudaConfigureCall(__cuda_local_var_17674_7_non_const_grid, __cuda_local_var_17675_7_non_const_threads, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z7Kernel2PbS_S_S_i(__cuda_local_var_17637_8_non_const_d_graph_mask, __cuda_local_var_17641_8_non_const_d_updating_graph_mask, __cuda_local_var_17646_8_non_const_d_graph_visited, __cuda_local_var_17661_8_non_const_d_over, no_of_nodes));



cudaMemcpy(((void *)(&__cuda_local_var_17679_7_non_const_stop)), ((const void *)__cuda_local_var_17661_8_non_const_d_over), 1UL, cudaMemcpyDeviceToHost);
__cuda_local_var_17677_6_non_const_k++;
} while (__cuda_local_var_17679_7_non_const_stop);
...
cudaMemcpy(((void *)__cuda_local_var_17651_7_non_const_h_cost), ((const void *)__cuda_local_var_17657_7_non_const_d_cost), (4UL * ((unsigned long)no_of_nodes)), cudaMemcpyDeviceToHost);
...
__cuda_local_var_17711_8_non_const_fpo = stdout; {
 int i;
# 230 "bfs.cu"
i = 0; for (; ((i < no_of_nodes) && (i < 1000)); i++) {
fprintf(__cuda_local_var_17711_8_non_const_fpo, ((const char *)"%d) cost:%d\n"), i, (__cuda_local_var_17651_7_non_const_h_cost[i])); } }
fclose(__cuda_local_var_17711_8_non_const_fpo);
...
free(((void *)__cuda_local_var_17651_7_non_const_h_cost));
cudaFree(((void *)__cuda_local_var_17627_8_non_const_d_graph_nodes));
cudaFree(((void *)__cuda_local_var_17632_7_non_const_d_graph_edges));
cudaFree(((void *)__cuda_local_var_17637_8_non_const_d_graph_mask));
cudaFree(((void *)__cuda_local_var_17641_8_non_const_d_updating_graph_mask));
cudaFree(((void *)__cuda_local_var_17646_8_non_const_d_graph_visited));
cudaFree(((void *)__cuda_local_var_17657_7_non_const_d_cost)); 
}
