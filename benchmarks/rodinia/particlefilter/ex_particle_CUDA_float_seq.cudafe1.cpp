...
# 26 "ex_particle_CUDA_float_seq.cu"
...
__attribute__((unused)) float calcLikelihoodSum(unsigned char *I, int *ind, int numOnes, int index) {int volatile ___ = 1;(void)I;(void)ind;(void)numOnes;(void)index;
# 102
exit(___);}
#if 0
# 96
...
__attribute__((unused)) void cdfCalc(float *CDF, float *weights, int Nparticles) {int volatile ___ = 1;(void)CDF;(void)weights;(void)Nparticles;
# 117
exit(___);}
#if 0
# 111
...
__attribute__((unused)) float d_randu(int *seed, int index) {int volatile ___ = 1;(void)seed;(void)index;
# 133
exit(___);}
#if 0
# 124
...
# 165
__attribute__((unused)) float d_randn(int *seed, int index) {int volatile ___ = 1;(void)seed;(void)index;
# 173
exit(___);}
#if 0
# 165
...
__attribute__((unused)) float updateWeights(float *weights, float *likelihood, int Nparticles) {int volatile ___ = 1;(void)weights;(void)likelihood;(void)Nparticles;
# 190
exit(___);}
#if 0
# 182
...
__attribute__((unused)) int findIndexBin(float *CDF, int beginIndex, int endIndex, float value) {int volatile ___ = 1;(void)CDF;(void)beginIndex;(void)endIndex;(void)value;
# 216
exit(___);}
#if 0
# 192
...
if (middleIndex == 0) { 
# 200
return middleIndex; } else { 
# 201
if ((CDF[middleIndex - 1]) < value) { 
# 202
return middleIndex; } else { 
# 203
if ((CDF[middleIndex - 1]) == value) { 
...
void find_index_kernel(float *arrayX, float *arrayY, float *CDF, float *u, float *xj, float *yj, float *weights, int Nparticles) ;
#if 0
# 229
{ 
# 230
...
void normalize_weights_kernel(float *weights, int Nparticles, float *partial_sums, float *CDF, float *u, int *seed) ;
#if 0
# 258
{ 
# 259
...
int i = (((blockDim.x) * block_id) + (threadIdx.x)); 
# 261
__attribute__((unused)) static float u1, sumWeights; 
# 262
...
void sum_kernel(float *partial_sums, int Nparticles) ;
#if 0
# 276
{ 
# 277
...
void likelihood_kernel(float *arrayX, float *arrayY, float *CDF, int *ind, int *objxy, float *likelihood, unsigned char *I, float *u, float *weights, int Nparticles, int countOnes, int max_size, int k, int IszY, int Nfr, int *seed, float *partial_sums) ;
#if 0
# 309
{ 
# 310
...
float indX, indY; 
# 314
__attribute__((unused)) static float buffer[512]; 
# 315
if (i < Nparticles) { 
# 316
...
for (k = 1; k < Nfr; k++) { 
# 682
cudaConfigureCall(num_blocks, threads_per_block) ? ((void)0) : likelihood_kernel(arrayX_GPU, arrayY_GPU, CDF_GPU, ind_GPU, objxy_GPU, likelihood_GPU, I_GPU, u_GPU, weights_GPU, Nparticles, countOnes, max_size, k, IszY, Nfr, seed_GPU, partial_sums); 
# 686
cudaConfigureCall(num_blocks, threads_per_block) ? ((void)0) : sum_kernel(partial_sums, Nparticles); 
# 689
cudaConfigureCall(num_blocks, threads_per_block) ? ((void)0) : normalize_weights_kernel(weights_GPU, Nparticles, partial_sums, CDF_GPU, u_GPU, seed_GPU); 
# 693
cudaConfigureCall(num_blocks, threads_per_block) ? ((void)0) : find_index_kernel(arrayX_GPU, arrayY_GPU, CDF_GPU, u_GPU, xj_GPU, yj_GPU, weights_GPU, Nparticles); 
# 696
}  
# 699
...
# 764
char *usage = ((char *)("float.out -x <dimX> -y <dimY> -z <Nfr> -np <Nparticles>")); 
# 766
if (argc != 9) { 
# 767
printf("%s\n", usage); 
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__34_ex_particle_CUDA_float_seq_cpp4_ii_M
# 1 "ex_particle_CUDA_float_seq.cudafe1.stub.c"
