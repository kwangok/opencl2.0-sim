...
int i, j; 
# 10
__attribute__((unused)) static float shadow[16][16]; 
# 12
...
{ 
# 51
__attribute__((unused)) static float dia[16][16]; 
# 52
__attribute__((unused)) static float peri_row[16][16]; 
# 53
__attribute__((unused)) static float peri_col[16][16]; 
# 55
...
for (i = 0; i < 16; i++) { 
# 69
(((peri_row)[i])[idx]) = (m[(array_offset + (((blockIdx.x) + (1)) * (16))) + idx]); 
# 70
array_offset += matrix_dim; 
# 71
}  
...
# 82
array_offset = (((offset + (((blockIdx.x) + (1)) * (16))) * matrix_dim) + offset); 
# 83
for (i = 0; i < 16; i++) { 
# 84
...
for (i = 1; i < 16; i++) { 
# 144
(m[(array_offset + (((blockIdx.x) + (1)) * (16))) + idx]) = (((peri_row)[i])[idx]); 
# 145
array_offset += matrix_dim; 
# 146
}  
...
float sum; 
# 167
int global_row_id = (offset + (((blockIdx.y) + (1)) * (16))); 
# 168
int global_col_id = (offset + (((blockIdx.x) + (1)) * (16))); 
# 170
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_lud_kernel_cpp4_ii_a8a59389
# 1 "lud_kernel.cudafe1.stub.c"
