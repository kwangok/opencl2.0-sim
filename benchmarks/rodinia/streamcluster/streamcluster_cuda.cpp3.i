# 1 "streamcluster_cuda.cudafe2.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "streamcluster_cuda.cudafe2.gpu"
...
__attribute__((global)) __attribute__((__used__)) extern void _Z12pgain_kerneliilP5PointiPfS1_PiPb(int, int, long, Point *, int, float *, float *, int *, __nv_bool *);
...
# 55 "streamcluster_cuda.cu"
__attribute__((global)) __attribute__((__used__)) void _Z12pgain_kerneliilP5PointiPfS1_PiPb(
# 55 "streamcluster_cuda.cu"
int num,
