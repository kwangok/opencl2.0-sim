...
# 23
__loc_sc__(__constant__,,) int c_tX[7 * 150]; 
# 24
__loc_sc__(__constant__,,) int c_tY[7 * 150]; 
# 27
__loc_sc__(__text__,,) texture< float, 1, cudaReadModeElementType>  t_grad_x; 
# 28
__loc_sc__(__text__,,) texture< float, 1, cudaReadModeElementType>  t_grad_y; 
# 32
...
# 137
__loc_sc__(__constant__,,) float c_strel[((12 * 2) + 1) * ((12 * 2) + 1)]; 
# 140
__loc_sc__(__text__,,) texture< float, 1, cudaReadModeElementType>  t_img; 
# 146
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__27_find_ellipse_kernel_cpp4_ii_t_grad_x
# 1 "find_ellipse_kernel.cudafe1.stub.c"
