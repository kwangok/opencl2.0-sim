...
# 5 "./srad_kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z11srad_cuda_1PfS_S_S_S_S_iif(float *, float *, float *, float *, float *, float *, int, int, float);
# 170 "./srad_kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z11srad_cuda_2PfS_S_S_S_S_iiff(float *, float *, float *, float *, float *, float *, int, int, float, float);
...
# 5 "./srad_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z11srad_cuda_1PfS_S_S_S_S_iif(
# 6 "./srad_kernel.cu"
float *E_C,
# 7 "./srad_kernel.cu"
float *W_C,
...
# 36 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17465_33_non_const_temp[16][16];
# 37 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17466_33_non_const_temp_result[16][16];
# 39 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17468_33_non_const_north[16][16];
# 40 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17469_33_non_const_south[16][16];
# 41 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17470_33_non_const_east[16][16];
# 42 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17471_33_non_const_west[16][16];
# 19 "./srad_kernel.cu"
...
# 170 "./srad_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z11srad_cuda_2PfS_S_S_S_S_iiff(
# 171 "./srad_kernel.cu"
float *E_C,
# 172 "./srad_kernel.cu"
float *W_C,
...
# 198 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17627_33_non_const_south_c[16][16];
# 199 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17628_35_non_const_east_c[16][16];
# 201 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17630_35_non_const_c_cuda_temp[16][16];
# 202 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17631_35_non_const_c_cuda_result[16][16];
# 203 "./srad_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17632_35_non_const_temp[16][16];
# 184 "./srad_kernel.cu"
