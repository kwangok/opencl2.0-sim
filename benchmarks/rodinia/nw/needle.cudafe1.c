...
# 82 "needle.cu"
 ...
 int *__cuda_local_var_17845_7_non_const_matrix_cuda;
# 83 "needle.cu"
 int *__cuda_local_var_17845_21_non_const_matrix_cuda_out;
# 83 "needle.cu"
 int *__cuda_local_var_17845_39_non_const_referrence_cuda;
 int __cuda_local_var_17846_6_non_const_size;
# 159 "needle.cu"
 dim3 __cuda_local_var_17921_10_non_const_dimGrid;
 dim3 __cuda_local_var_17922_7_non_const_dimBlock;
 int __cuda_local_var_17923_6_non_const_block_width;
# 194 "needle.cu"
 FILE *__cuda_local_var_17956_8_non_const_fpo;
# 89 "needle.cu"
if (argc == 3)
{
...
__cuda_local_var_17846_6_non_const_size = (__cuda_local_var_17843_19_non_const_max_cols * __cuda_local_var_17843_9_non_const_max_rows);
cudaMalloc(((void **)(&__cuda_local_var_17845_39_non_const_referrence_cuda)), (4UL * ((unsigned long)__cuda_local_var_17846_6_non_const_size)));
cudaMalloc(((void **)(&__cuda_local_var_17845_7_non_const_matrix_cuda)), (4UL * ((unsigned long)__cuda_local_var_17846_6_non_const_size)));
cudaMalloc(((void **)(&__cuda_local_var_17845_21_non_const_matrix_cuda_out)), (4UL * ((unsigned long)__cuda_local_var_17846_6_non_const_size)));
...
cudaMemcpy(((void *)__cuda_local_var_17845_39_non_const_referrence_cuda), ((const void *)__cuda_local_var_17844_45_non_const_referrence), (4UL * ((unsigned long)__cuda_local_var_17846_6_non_const_size)), cudaMemcpyHostToDevice);
cudaMemcpy(((void *)__cuda_local_var_17845_7_non_const_matrix_cuda), ((const void *)__cuda_local_var_17844_10_non_const_input_itemsets), (4UL * ((unsigned long)__cuda_local_var_17846_6_non_const_size)), cudaMemcpyHostToDevice);

{ (__cuda_local_var_17921_10_non_const_dimGrid.x) = 1U; (__cuda_local_var_17921_10_non_const_dimGrid.y) = 1U; (__cuda_local_var_17921_10_non_const_dimGrid.z) = 1U; }
{ (__cuda_local_var_17922_7_non_const_dimBlock.x) = 16U; (__cuda_local_var_17922_7_non_const_dimBlock.y) = 1U; (__cuda_local_var_17922_7_non_const_dimBlock.z) = 1U; }
__cuda_local_var_17923_6_non_const_block_width = ((__cuda_local_var_17843_19_non_const_max_cols - 1) / 16);

printf(((const char *)"Processing top-left matrix\n")); {

 int i;
# 165 "needle.cu"
i = 1; for (; (i <= __cuda_local_var_17923_6_non_const_block_width); i++) {
(__cuda_local_var_17921_10_non_const_dimGrid.x) = ((unsigned)i);
(__cuda_local_var_17921_10_non_const_dimGrid.y) = 1U;
(cudaConfigureCall(__cuda_local_var_17921_10_non_const_dimGrid, __cuda_local_var_17922_7_non_const_dimBlock, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z20needle_cuda_shared_1PiS_S_iiii(__cuda_local_var_17845_39_non_const_referrence_cuda, __cuda_local_var_17845_7_non_const_matrix_cuda, __cuda_local_var_17845_21_non_const_matrix_cuda_out, __cuda_local_var_17843_19_non_const_max_cols, __cuda_local_var_17843_29_non_const_penalty, i, __cuda_local_var_17923_6_non_const_block_width));
...
printf(((const char *)"Processing bottom-right matrix\n")); {
 ...
 int i;
# 173 "needle.cu"
i = (__cuda_local_var_17923_6_non_const_block_width - 1); for (; (i >= 1); i--) {
(__cuda_local_var_17921_10_non_const_dimGrid.x) = ((unsigned)i);
(__cuda_local_var_17921_10_non_const_dimGrid.y) = 1U;
(cudaConfigureCall(__cuda_local_var_17921_10_non_const_dimGrid, __cuda_local_var_17922_7_non_const_dimBlock, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z20needle_cuda_shared_2PiS_S_iiii(__cuda_local_var_17845_39_non_const_referrence_cuda, __cuda_local_var_17845_7_non_const_matrix_cuda, __cuda_local_var_17845_21_non_const_matrix_cuda_out, __cuda_local_var_17843_19_non_const_max_cols, __cuda_local_var_17843_29_non_const_penalty, i, __cuda_local_var_17923_6_non_const_block_width));

} }


cudaMemcpy(((void *)__cuda_local_var_17844_27_non_const_output_itemsets), ((const void *)__cuda_local_var_17845_7_non_const_matrix_cuda), (4UL * ((unsigned long)__cuda_local_var_17846_6_non_const_size)), cudaMemcpyDeviceToHost);
...
__cuda_local_var_17956_8_non_const_fpo = stdout;
fprintf(__cuda_local_var_17956_8_non_const_fpo, ((const char *)"print traceback value GPU:\n")); {
...
i = (__cuda_local_var_17843_9_non_const_max_rows - 2); j = (__cuda_local_var_17843_9_non_const_max_rows - 2); for (; (((char)(i >= 0)) , (j >= 0)); ) { {
 int __cuda_local_var_17960_7_non_const_nw;
# 198 "needle.cu"
 int __cuda_local_var_17960_11_non_const_n;
# 198 "needle.cu"
 int __cuda_local_var_17960_14_non_const_w;
# 198 "needle.cu"
 int __cuda_local_var_17960_17_non_const_traceback;
# 220 "needle.cu"
 int __cuda_local_var_17982_7_non_const_new_nw;
# 220 "needle.cu"
 int __cuda_local_var_17982_15_non_const_new_w;
# 220 "needle.cu"
 int __cuda_local_var_17982_22_non_const_new_n;
# 199 "needle.cu"
if ((i == (__cuda_local_var_17843_9_non_const_max_rows - 2)) && (j == (__cuda_local_var_17843_9_non_const_max_rows - 2))) {
fprintf(__cuda_local_var_17956_8_non_const_fpo, ((const char *)"%d "), (__cuda_local_var_17844_27_non_const_output_itemsets[((i * __cuda_local_var_17843_19_non_const_max_cols) + j)])); }
if ((i == 0) && (j == 0)) {
goto __T24; }
if ((i > 0) && (j > 0)) {
__cuda_local_var_17960_7_non_const_nw = (__cuda_local_var_17844_27_non_const_output_itemsets[((((i - 1) * __cuda_local_var_17843_19_non_const_max_cols) + j) - 1)]);
__cuda_local_var_17960_14_non_const_w = (__cuda_local_var_17844_27_non_const_output_itemsets[(((i * __cuda_local_var_17843_19_non_const_max_cols) + j) - 1)]);
__cuda_local_var_17960_11_non_const_n = (__cuda_local_var_17844_27_non_const_output_itemsets[(((i - 1) * __cuda_local_var_17843_19_non_const_max_cols) + j)]);
} else  {
if (i == 0) {
__cuda_local_var_17960_7_non_const_nw = (__cuda_local_var_17960_11_non_const_n = (-999));
__cuda_local_var_17960_14_non_const_w = (__cuda_local_var_17844_27_non_const_output_itemsets[(((i * __cuda_local_var_17843_19_non_const_max_cols) + j) - 1)]);
} else  {
if (j == 0) {
__cuda_local_var_17960_7_non_const_nw = (__cuda_local_var_17960_14_non_const_w = (-999));
__cuda_local_var_17960_11_non_const_n = (__cuda_local_var_17844_27_non_const_output_itemsets[(((i - 1) * __cuda_local_var_17843_19_non_const_max_cols) + j)]);
}
else  {
} } }
...
__cuda_local_var_17982_7_non_const_new_nw = (__cuda_local_var_17960_7_non_const_nw + (__cuda_local_var_17844_45_non_const_referrence[((i * __cuda_local_var_17843_19_non_const_max_cols) + j)]));
__cuda_local_var_17982_15_non_const_new_w = (__cuda_local_var_17960_14_non_const_w - __cuda_local_var_17843_29_non_const_penalty);
__cuda_local_var_17982_22_non_const_new_n = (__cuda_local_var_17960_11_non_const_n - __cuda_local_var_17843_29_non_const_penalty);

__cuda_local_var_17960_17_non_const_traceback = (_Z7maximumiii(__cuda_local_var_17982_7_non_const_new_nw, __cuda_local_var_17982_15_non_const_new_w, __cuda_local_var_17982_22_non_const_new_n));
if (__cuda_local_var_17960_17_non_const_traceback == __cuda_local_var_17982_7_non_const_new_nw) {
__cuda_local_var_17960_17_non_const_traceback = __cuda_local_var_17960_7_non_const_nw; }
if (__cuda_local_var_17960_17_non_const_traceback == __cuda_local_var_17982_15_non_const_new_w) {
__cuda_local_var_17960_17_non_const_traceback = __cuda_local_var_17960_14_non_const_w; }
if (__cuda_local_var_17960_17_non_const_traceback == __cuda_local_var_17982_22_non_const_new_n) {
__cuda_local_var_17960_17_non_const_traceback = __cuda_local_var_17960_11_non_const_n; }

fprintf(__cuda_local_var_17956_8_non_const_fpo, ((const char *)"%d "), __cuda_local_var_17960_17_non_const_traceback);

if (__cuda_local_var_17960_17_non_const_traceback == __cuda_local_var_17960_7_non_const_nw)
{ i--; j--; goto __T25; } else  {

if (__cuda_local_var_17960_17_non_const_traceback == __cuda_local_var_17960_14_non_const_w)
{ j--; goto __T25; } else  {

if (__cuda_local_var_17960_17_non_const_traceback == __cuda_local_var_17960_11_non_const_n)
{ i--; goto __T25; } else  {


; } } }
} __T25:; } } __T24:;
fprintf(__cuda_local_var_17956_8_non_const_fpo, ((const char *)"\n"));
fflush(__cuda_local_var_17956_8_non_const_fpo);
...
cudaFree(((void *)__cuda_local_var_17845_39_non_const_referrence_cuda));
cudaFree(((void *)__cuda_local_var_17845_7_non_const_matrix_cuda));
cudaFree(((void *)__cuda_local_var_17845_21_non_const_matrix_cuda_out));

free(((void *)__cuda_local_var_17844_45_non_const_referrence));
free(((void *)__cuda_local_var_17844_10_non_const_input_itemsets));
free(((void *)__cuda_local_var_17844_27_non_const_output_itemsets)); 
