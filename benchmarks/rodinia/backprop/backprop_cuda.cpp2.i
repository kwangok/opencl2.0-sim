...
# 311 "/home/bachelor/deicide218/cuda-4.2/include/device_functions.h"
 __attribute__((device_builtin)) extern __attribute__((device)) float __log2f(float);
# 348 "/home/bachelor/deicide218/cuda-4.2/include/device_functions.h"
 __attribute__((device_builtin)) extern __attribute__((device)) float __powf(float, float);
...
__attribute__((global)) extern void _Z22bpnn_layerforward_CUDAPfS_S_S_ii(float *, float *, float *, float *, int, int);
# 81 "./backprop_cuda_kernel.cu"
__attribute__((global)) extern void _Z24bpnn_adjust_weights_cudaPfiS_iS_S_(float *, int, float *, int, float *, float *);
...
# 13 "./backprop_cuda_kernel.cu"
__attribute__((global)) void _Z22bpnn_layerforward_CUDAPfS_S_S_ii(
# 13 "./backprop_cuda_kernel.cu"
float *input_cuda,
...
# 28 "./backprop_cuda_kernel.cu"
 __attribute__((shared)) float __cuda_local_var_17594_34_non_const_input_node[16];
# 29 "./backprop_cuda_kernel.cu"
 __attribute__((shared)) float __cuda_local_var_17595_34_non_const_weight_matrix[16][16];
# 20 "./backprop_cuda_kernel.cu"
...
# 47 "./backprop_cuda_kernel.cu"
__cuda_local_var_17613_9_non_const_power_two = ((int)__float2int_rz((float)((__powf((2.0F), ((float)i))))));
...
# 81 "./backprop_cuda_kernel.cu"
__attribute__((global)) void _Z24bpnn_adjust_weights_cudaPfiS_iS_S_(
# 81 "./backprop_cuda_kernel.cu"
float *delta,
