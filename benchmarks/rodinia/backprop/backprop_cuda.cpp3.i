...
__attribute__((global)) __attribute__((__used__)) extern void _Z22bpnn_layerforward_CUDAPfS_S_S_ii(float *, float *, float *, float *, int, int);
# 81 "./backprop_cuda_kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z24bpnn_adjust_weights_cudaPfiS_iS_S_(float *, int, float *, int, float *, float *);
...
# 83 "./backprop_cuda_kernel.cu" 2
# 13 "./backprop_cuda_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z22bpnn_layerforward_CUDAPfS_S_S_ii(
# 13 "./backprop_cuda_kernel.cu"
float *input_cuda,
...
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17594_34_non_const_input_node[16];
# 29 "./backprop_cuda_kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_17595_34_non_const_weight_matrix[16][16];
# 20 "./backprop_cuda_kernel.cu"
...
# 58 "./backprop_cuda_kernel.cu"
(input_hidden_cuda[__cuda_local_var_17590_8_non_const_index]) = ((((__cuda_local_var_17595_34_non_const_weight_matrix)[__cuda_local_var_17588_8_non_const_ty]))[__cuda_local_var_17587_8_non_const_tx]);
...
# 81 "./backprop_cuda_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z24bpnn_adjust_weights_cudaPfiS_iS_S_(
# 81 "./backprop_cuda_kernel.cu"
float *delta,
...
# 90 "./backprop_cuda_kernel.cu"
 int __cuda_local_var_17644_8_non_const_by;
# 92 "./backprop_cuda_kernel.cu"
 int __cuda_local_var_17646_8_non_const_tx;
# 93 "./backprop_cuda_kernel.cu"
 int __cuda_local_var_17647_8_non_const_ty;
# 95 "./backprop_cuda_kernel.cu"
 int __cuda_local_var_17649_8_non_const_index;
# 96 "./backprop_cuda_kernel.cu"
 int __cuda_local_var_17650_8_non_const_index_y;
# 97 "./backprop_cuda_kernel.cu"
 int __cuda_local_var_17651_8_non_const_index_x;
# 90 "./backprop_cuda_kernel.cu"
__cuda_local_var_17644_8_non_const_by = ((int)(blockIdx.y));
# 92 "./backprop_cuda_kernel.cu"
__cuda_local_var_17646_8_non_const_tx = ((int)(threadIdx.x));
# 93 "./backprop_cuda_kernel.cu"
__cuda_local_var_17647_8_non_const_ty = ((int)(threadIdx.y));
# 95 "./backprop_cuda_kernel.cu"
__cuda_local_var_17649_8_non_const_index = (((((((hid + 1) * 16) * __cuda_local_var_17644_8_non_const_by) + ((hid + 1) * __cuda_local_var_17647_8_non_const_ty)) + __cuda_local_var_17646_8_non_const_tx) + 1) + (hid + 1));
# 96 "./backprop_cuda_kernel.cu"
__cuda_local_var_17650_8_non_const_index_y = (((16 * __cuda_local_var_17644_8_non_const_by) + __cuda_local_var_17647_8_non_const_ty) + 1);
# 97 "./backprop_cuda_kernel.cu"
__cuda_local_var_17651_8_non_const_index_x = (__cuda_local_var_17646_8_non_const_tx + 1);
# 101 "./backprop_cuda_kernel.cu"
(w[__cuda_local_var_17649_8_non_const_index]) += ((((0.2999999999999999889) * ((double)(delta[__cuda_local_var_17651_8_non_const_index_x]))) * ((double)(ly[__cuda_local_var_17650_8_non_const_index_y]))) + ((0.2999999999999999889) * ((double)(oldw[__cuda_local_var_17649_8_non_const_index]))));
# 102 "./backprop_cuda_kernel.cu"
(oldw[__cuda_local_var_17649_8_non_const_index]) = ((float)((((0.2999999999999999889) * ((double)(delta[__cuda_local_var_17651_8_non_const_index_x]))) * ((double)(ly[__cuda_local_var_17650_8_non_const_index_y]))) + ((0.2999999999999999889) * ((double)(oldw[__cuda_local_var_17649_8_non_const_index])))));
# 105 "./backprop_cuda_kernel.cu"
__syncthreads();
# 107 "./backprop_cuda_kernel.cu"
if ((__cuda_local_var_17647_8_non_const_ty == 0) && (__cuda_local_var_17644_8_non_const_by == 0))
# 107 "./backprop_cuda_kernel.cu"
{
# 108 "./backprop_cuda_kernel.cu"
(w[__cuda_local_var_17651_8_non_const_index_x]) += (((0.2999999999999999889) * ((double)(delta[__cuda_local_var_17651_8_non_const_index_x]))) + ((0.2999999999999999889) * ((double)(oldw[__cuda_local_var_17651_8_non_const_index_x]))));
# 109 "./backprop_cuda_kernel.cu"
(oldw[__cuda_local_var_17651_8_non_const_index_x]) = ((float)(((0.2999999999999999889) * ((double)(delta[__cuda_local_var_17651_8_non_const_index_x]))) + ((0.2999999999999999889) * ((double)(oldw[__cuda_local_var_17651_8_non_const_index_x])))));
