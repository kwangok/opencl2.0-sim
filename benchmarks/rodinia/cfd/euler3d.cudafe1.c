...
# 80 "euler3d.cu"
extern  __attribute__((__weak__)) /* COMDAT group: _Z8downloadIfEvPT_S1_i */ void _Z8downloadIfEvPT_S1_i(float *, float *, int);
# 134 "euler3d.cu"
extern void _Z20initialize_variablesiPf(int, float *);
# 204 "euler3d.cu"
extern void _Z19compute_step_factoriPfS_S_(int, float *, float *, float *);
# 345 "euler3d.cu"
extern void _Z12compute_fluxiPiPfS0_S0_(int, int *, float *, float *, float *);
# 364 "euler3d.cu"
...
extern  __attribute__((__weak__)) /* COMDAT group: _Z18cudaMemcpyToSymbolIA5_fE9cudaErrorRKT_PKvmm14cudaMemcpyKind */ __inline__ cudaError_t _Z18cudaMemcpyToSymbolIA5_fE9cudaErrorRKT_PKvmm14cudaMemcpyKind(const float (*)[5], const void *, size_t, size_t, enum cudaMemcpyKind);
# 301 "/home/bachelor/deicide218/cuda-4.2/include/cuda_runtime.h"
extern  __attribute__((__weak__)) /* COMDAT group: _Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind */ __inline__ cudaError_t _Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind(const float3 (*)[1], const void *, size_t, size_t, enum cudaMemcpyKind);
# 74 "euler3d.cu"
extern  __attribute__((__weak__)) /* COMDAT group: _Z6uploadIfEvPT_S1_i */ void _Z6uploadIfEvPT_S1_i(float *, float *, int);
# 74 "euler3d.cu"
extern  __attribute__((__weak__)) /* COMDAT group: _Z6uploadIiEvPT_S1_i */ void _Z6uploadIiEvPT_S1_i(int *, int *, int);
# 68 "euler3d.cu"
extern  __attribute__((__weak__)) /* COMDAT group: _Z4copyIfEvPT_S1_i */ void _Z4copyIfEvPT_S1_i(float *, float *, int);
# 62 "euler3d.cu"
extern  __attribute__((__weak__)) /* COMDAT group: _Z7deallocIfEvPT_ */ void _Z7deallocIfEvPT_(float *);
# 62 "euler3d.cu"
extern  __attribute__((__weak__)) /* COMDAT group: _Z7deallocIiEvPT_ */ void _Z7deallocIiEvPT_(int *);
...
static void __sti___15_euler3d_cpp1_ii_78e67203(void) __attribute__((__constructor__));
...
# 85 "euler3d.cu"
void _Z4dumpPfii( float *variables,  int nel,  int nelr)
{
 float *__cuda_local_var_35670_9_non_const_h_variables;
# 87 "euler3d.cu"
__cuda_local_var_35670_9_non_const_h_variables = ((float *)(_Znam((((unsigned long)(nelr * 5)) * 4UL))));
_Z8downloadIfEvPT_S1_i(__cuda_local_var_35670_9_non_const_h_variables, variables, (nelr * 5));

{

_ZNSolsEPFRSoS_E((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((&_ZSt4cout), ((const char *)"density:"))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_);
_ZNSolsEPFRSoS_E((_ZNSolsEi((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((_ZNSolsEi((&_ZSt4cout), nel)), ((const char *)" "))), nelr)), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_); {
 int i;
# 94 "euler3d.cu"
i = 0; for (; (i < nel); i++) { _ZNSolsEPFRSoS_E((_ZNSolsEf((&_ZSt4cout), (__cuda_local_var_35670_9_non_const_h_variables[(i + (0 * nelr))]))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_); } }
}


{

_ZNSolsEPFRSoS_E((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((&_ZSt4cout), ((const char *)"momentum:"))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_);
_ZNSolsEPFRSoS_E((_ZNSolsEi((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((_ZNSolsEi((&_ZSt4cout), nel)), ((const char *)" "))), nelr)), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_); {
 int i;
# 102 "euler3d.cu"
i = 0; for (; (i < nel); i++)
...
# 104 "euler3d.cu"
j = 0; for (; (j != 3); j++) {
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((_ZNSolsEf((&_ZSt4cout), (__cuda_local_var_35670_9_non_const_h_variables[(i + ((1 + j) * nelr))]))), ((const char *)" ")); } }
...
_ZNSolsEPFRSoS_E((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((&_ZSt4cout), ((const char *)"density_energy:"))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_);
_ZNSolsEPFRSoS_E((_ZNSolsEi((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((_ZNSolsEi((&_ZSt4cout), nel)), ((const char *)" "))), nelr)), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_); {
 int i;
# 114 "euler3d.cu"
i = 0; for (; (i < nel); i++) { _ZNSolsEPFRSoS_E((_ZNSolsEf((&_ZSt4cout), (__cuda_local_var_35670_9_non_const_h_variables[(i + (4 * nelr))]))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_); } }
}
_ZdaPv(((void *)__cuda_local_var_35670_9_non_const_h_variables)); 
}
# 80 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z8downloadIfEvPT_S1_i */ void _Z8downloadIfEvPT_S1_i( float *dst,  float *src,  int N)
{
{  enum cudaError __cuda_local_var_35665_14_non_const_err;
# 82 "euler3d.cu"
__cuda_local_var_35665_14_non_const_err = (cudaMemcpy(((void *)dst), ((const void *)((void *)src)), (((unsigned long)N) * 4UL), cudaMemcpyDeviceToHost)); if (0 != ((int)__cuda_local_var_35665_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 82, (cudaGetErrorString(__cuda_local_var_35665_14_non_const_err))); exit(1); } } ; ; 
}
# 134 "euler3d.cu"
void _Z20initialize_variablesiPf( int nelr,  float *variables)
{  unsigned __T20;
 dim3 __cuda_local_var_35719_7_non_const_Dg;
# 136 "euler3d.cu"
 dim3 __cuda_local_var_35719_23_non_const_Db;
# 136 "euler3d.cu"
{ __T20 = ((unsigned)(nelr / 192)); { (__cuda_local_var_35719_7_non_const_Dg.x) = __T20; (__cuda_local_var_35719_7_non_const_Dg.y) = 1U; (__cuda_local_var_35719_7_non_const_Dg.z) = 1U; } } { (__cuda_local_var_35719_23_non_const_Db.x) = 192U; (__cuda_local_var_35719_23_non_const_Db.y) = 1U; (__cuda_local_var_35719_23_non_const_Db.z) = 1U; }
(cudaConfigureCall(__cuda_local_var_35719_7_non_const_Dg, __cuda_local_var_35719_23_non_const_Db, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z25cuda_initialize_variablesiPf(nelr, variables));
{  cudaError_t __cuda_local_var_35721_16_non_const_err;
# 138 "euler3d.cu"
__cuda_local_var_35721_16_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_35721_16_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("initialize_variables failed")), ((const char *)("euler3d.cu")), 138, (cudaGetErrorString(__cuda_local_var_35721_16_non_const_err))); exit(1); } } ; 
}
# 204 "euler3d.cu"
void _Z19compute_step_factoriPfS_S_( int nelr,  float *variables,  float *areas,  float *step_factors)
{  unsigned __T21;
 dim3 __cuda_local_var_35789_7_non_const_Dg;
# 206 "euler3d.cu"
 dim3 __cuda_local_var_35789_23_non_const_Db;
# 206 "euler3d.cu"
{ __T21 = ((unsigned)(nelr / 192)); { (__cuda_local_var_35789_7_non_const_Dg.x) = __T21; (__cuda_local_var_35789_7_non_const_Dg.y) = 1U; (__cuda_local_var_35789_7_non_const_Dg.z) = 1U; } } { (__cuda_local_var_35789_23_non_const_Db.x) = 192U; (__cuda_local_var_35789_23_non_const_Db.y) = 1U; (__cuda_local_var_35789_23_non_const_Db.z) = 1U; }
(cudaConfigureCall(__cuda_local_var_35789_7_non_const_Dg, __cuda_local_var_35789_23_non_const_Db, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z24cuda_compute_step_factoriPfS_S_(nelr, variables, areas, step_factors));
{  cudaError_t __cuda_local_var_35791_16_non_const_err;
# 208 "euler3d.cu"
__cuda_local_var_35791_16_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_35791_16_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("compute_step_factor failed")), ((const char *)("euler3d.cu")), 208, (cudaGetErrorString(__cuda_local_var_35791_16_non_const_err))); exit(1); } } ; 
}
# 345 "euler3d.cu"
void _Z12compute_fluxiPiPfS0_S0_( int nelr,  int *elements_surrounding_elements,  float *normals,  float *variables,  float *fluxes)
{  unsigned __T22;
 dim3 __cuda_local_var_35930_7_non_const_Dg;
# 347 "euler3d.cu"
 dim3 __cuda_local_var_35930_23_non_const_Db;
# 347 "euler3d.cu"
{ __T22 = ((unsigned)(nelr / 192)); { (__cuda_local_var_35930_7_non_const_Dg.x) = __T22; (__cuda_local_var_35930_7_non_const_Dg.y) = 1U; (__cuda_local_var_35930_7_non_const_Dg.z) = 1U; } } { (__cuda_local_var_35930_23_non_const_Db.x) = 192U; (__cuda_local_var_35930_23_non_const_Db.y) = 1U; (__cuda_local_var_35930_23_non_const_Db.z) = 1U; }
(cudaConfigureCall(__cuda_local_var_35930_7_non_const_Dg, __cuda_local_var_35930_23_non_const_Db, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z17cuda_compute_fluxiPiPfS0_S0_(nelr, elements_surrounding_elements, normals, variables, fluxes));
{  cudaError_t __cuda_local_var_35932_16_non_const_err;
# 349 "euler3d.cu"
__cuda_local_var_35932_16_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_35932_16_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("compute_flux failed")), ((const char *)("euler3d.cu")), 349, (cudaGetErrorString(__cuda_local_var_35932_16_non_const_err))); exit(1); } } ; 
}
# 364 "euler3d.cu"
void _Z9time_stepiiPfS_S_S_( int j,  int nelr,  float *old_variables,  float *variables,  float *step_factors,  float *fluxes)
{  unsigned __T23;
 dim3 __cuda_local_var_35949_7_non_const_Dg;
# 366 "euler3d.cu"
 dim3 __cuda_local_var_35949_23_non_const_Db;
# 366 "euler3d.cu"
{ __T23 = ((unsigned)(nelr / 192)); { (__cuda_local_var_35949_7_non_const_Dg.x) = __T23; (__cuda_local_var_35949_7_non_const_Dg.y) = 1U; (__cuda_local_var_35949_7_non_const_Dg.z) = 1U; } } { (__cuda_local_var_35949_23_non_const_Db.x) = 192U; (__cuda_local_var_35949_23_non_const_Db.y) = 1U; (__cuda_local_var_35949_23_non_const_Db.z) = 1U; }
(cudaConfigureCall(__cuda_local_var_35949_7_non_const_Dg, __cuda_local_var_35949_23_non_const_Db, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z14cuda_time_stepiiPfS_S_S_(j, nelr, old_variables, variables, step_factors, fluxes));
{  cudaError_t __cuda_local_var_35951_16_non_const_err;
# 368 "euler3d.cu"
__cuda_local_var_35951_16_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_35951_16_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("update failed")), ((const char *)("euler3d.cu")), 368, (cudaGetErrorString(__cuda_local_var_35951_16_non_const_err))); exit(1); } } ; 
}
...
{  const char *__T24;
 ...
 const char *__cuda_local_var_35964_14_non_const_data_file_name;




 struct cudaDeviceProp __cuda_local_var_35969_17_non_const_prop;
 int __cuda_local_var_35970_6_non_const_dev;
# 397 "euler3d.cu"
 float __cuda_local_var_35980_9_non_const_h_ff_variable[5];
 float __cuda_local_var_35981_15_const_angle_of_attack;



 float __cuda_local_var_35985_9_non_const_ff_pressure;
 float __cuda_local_var_35986_9_non_const_ff_speed_of_sound;
 float __cuda_local_var_35987_9_non_const_ff_speed;

 float3 __cuda_local_var_35989_10_non_const_ff_velocity;
# 417 "euler3d.cu"
 float3 __cuda_local_var_36000_10_non_const_h_ff_momentum;



 float3 __cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x;
 float3 __cuda_local_var_36005_10_non_const_h_ff_flux_contribution_momentum_y;
 float3 __cuda_local_var_36006_10_non_const_h_ff_flux_contribution_momentum_z;
 float3 __cuda_local_var_36007_10_non_const_h_ff_flux_contribution_density_energy;



 int __cuda_local_var_36011_6_non_const_nel;
 int __cuda_local_var_36012_6_non_const_nelr;


 float *__cuda_local_var_36015_9_non_const_areas;
 int *__cuda_local_var_36016_7_non_const_elements_surrounding_elements;
 float *__cuda_local_var_36017_9_non_const_normals;

 _ZSt8ifstream __cuda_local_var_36019_17_non_const_file;




 float *__cuda_local_var_36024_10_non_const_h_areas;
 int *__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements;
 float *__cuda_local_var_36026_10_non_const_h_normals;
# 465 "euler3d.cu"
 int __cuda_local_var_36048_7_non_const_last;
# 504 "euler3d.cu"
 float *__cuda_local_var_36087_9_non_const_variables;


 float *__cuda_local_var_36090_9_non_const_old_variables;
 float *__cuda_local_var_36091_9_non_const_fluxes;
 float *__cuda_local_var_36092_9_non_const_step_factors;
# 522 "euler3d.cu"
 unsigned __cuda_local_var_36105_15_non_const_timer;
# 376 "euler3d.cu"
if (argc < 2)
{
...
__cuda_local_var_35964_14_non_const_data_file_name = ((const char *)(argv[1]));
if (argc == 3) {
iterations = ((unsigned)((__T24 = ((const char *)(argv[2]))) , ((int)(strtol(__T24, ((char **)0LL), 10)))));
}




{  enum cudaError __cuda_local_var_35972_14_non_const_err;
# 389 "euler3d.cu"
__cuda_local_var_35972_14_non_const_err = (cudaSetDevice(0)); if (0 != ((int)__cuda_local_var_35972_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 389, (cudaGetErrorString(__cuda_local_var_35972_14_non_const_err))); exit(1); } } ; ;
{  enum cudaError __cuda_local_var_35973_14_non_const_err;
# 390 "euler3d.cu"
__cuda_local_var_35973_14_non_const_err = (cudaGetDevice((&__cuda_local_var_35970_6_non_const_dev))); if (0 != ((int)__cuda_local_var_35973_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 390, (cudaGetErrorString(__cuda_local_var_35973_14_non_const_err))); exit(1); } } ; ;
{  enum cudaError __cuda_local_var_35974_14_non_const_err;
# 391 "euler3d.cu"
__cuda_local_var_35974_14_non_const_err = (cudaGetDeviceProperties((&__cuda_local_var_35969_17_non_const_prop), __cuda_local_var_35970_6_non_const_dev)); if (0 != ((int)__cuda_local_var_35974_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 391, (cudaGetErrorString(__cuda_local_var_35974_14_non_const_err))); exit(1); } } ; ;

printf(((const char *)"Name:                     %s\n"), ((__cuda_local_var_35969_17_non_const_prop.name)));




__cuda_local_var_35981_15_const_angle_of_attack = (0.0F);

((__cuda_local_var_35980_9_non_const_h_ff_variable)[0]) = (1.399999976F);

__cuda_local_var_35985_9_non_const_ff_pressure = (1.0F);
__cuda_local_var_35986_9_non_const_ff_speed_of_sound = ((__T25 = (((1.399999976F) * __cuda_local_var_35985_9_non_const_ff_pressure) / ((__cuda_local_var_35980_9_non_const_h_ff_variable)[0]))) , (__builtin_sqrtf(__T25)));
__cuda_local_var_35987_9_non_const_ff_speed = ((1.200000048F) * __cuda_local_var_35986_9_non_const_ff_speed_of_sound);


(__cuda_local_var_35989_10_non_const_ff_velocity.x) = (__cuda_local_var_35987_9_non_const_ff_speed * ((float)(__builtin_cosf((0.0F)))));
(__cuda_local_var_35989_10_non_const_ff_velocity.y) = (__cuda_local_var_35987_9_non_const_ff_speed * ((float)(__builtin_sinf((0.0F)))));
(__cuda_local_var_35989_10_non_const_ff_velocity.z) = (0.0F);

((__cuda_local_var_35980_9_non_const_h_ff_variable)[1]) = (((__cuda_local_var_35980_9_non_const_h_ff_variable)[0]) * (__cuda_local_var_35989_10_non_const_ff_velocity.x));
((__cuda_local_var_35980_9_non_const_h_ff_variable)[2]) = (((__cuda_local_var_35980_9_non_const_h_ff_variable)[0]) * (__cuda_local_var_35989_10_non_const_ff_velocity.y));
((__cuda_local_var_35980_9_non_const_h_ff_variable)[3]) = (((__cuda_local_var_35980_9_non_const_h_ff_variable)[0]) * (__cuda_local_var_35989_10_non_const_ff_velocity.z));

((__cuda_local_var_35980_9_non_const_h_ff_variable)[4]) = ((((__cuda_local_var_35980_9_non_const_h_ff_variable)[0]) * ((0.5F) * (__cuda_local_var_35987_9_non_const_ff_speed * __cuda_local_var_35987_9_non_const_ff_speed))) + (__cuda_local_var_35985_9_non_const_ff_pressure / (0.3999999762F)));


(__cuda_local_var_36000_10_non_const_h_ff_momentum.x) = (*(((__cuda_local_var_35980_9_non_const_h_ff_variable) + 1) + 0));
(__cuda_local_var_36000_10_non_const_h_ff_momentum.y) = (*(((__cuda_local_var_35980_9_non_const_h_ff_variable) + 1) + 1));
(__cuda_local_var_36000_10_non_const_h_ff_momentum.z) = (*(((__cuda_local_var_35980_9_non_const_h_ff_variable) + 1) + 2));
# 436 "euler3d.cu"
_ZNSt14basic_ifstreamIcSt11char_traitsIcEEC1EPKcSt13_Ios_Openmode((&__cuda_local_var_36019_17_non_const_file), __cuda_local_var_35964_14_non_const_data_file_name, ((_ZNSt8ios_base8openmodeE)8));

_ZNSirsERi((((struct _ZSi *)&__cuda_local_var_36019_17_non_const_file)), (&__cuda_local_var_36011_6_non_const_nel));
__cuda_local_var_36012_6_non_const_nelr = (192 * ((__cuda_local_var_36011_6_non_const_nel / 192) + (*(_ZSt3minIiERKT_S2_S2_(((__T26 = 1) , (((const int *)&__T26))), ((__T27 = (__cuda_local_var_36011_6_non_const_nel % 192)) , (((const int *)&__T27))))))));

__cuda_local_var_36024_10_non_const_h_areas = ((float *)(_Znam((((unsigned long)__cuda_local_var_36012_6_non_const_nelr) * 4UL))));
__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements = ((int *)(_Znam((((unsigned long)(__cuda_local_var_36012_6_non_const_nelr * 4)) * 4UL))));
__cuda_local_var_36026_10_non_const_h_normals = ((float *)(_Znam((((unsigned long)((__cuda_local_var_36012_6_non_const_nelr * 3) * 4)) * 4UL)))); {



 int i;
# 447 "euler3d.cu"
i = 0; for (; (i < __cuda_local_var_36011_6_non_const_nel); i++)
{
_ZNSirsERf((((struct _ZSi *)&__cuda_local_var_36019_17_non_const_file)), (__cuda_local_var_36024_10_non_const_h_areas + i)); {
 int j;
# 450 "euler3d.cu"
j = 0; for (; (j < 4); j++)
{
_ZNSirsERi((((struct _ZSi *)&__cuda_local_var_36019_17_non_const_file)), (__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements + (i + (j * __cuda_local_var_36012_6_non_const_nelr))));
if ((__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements[(i + (j * __cuda_local_var_36012_6_non_const_nelr))]) < 0) { (__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements[(i + (j * __cuda_local_var_36012_6_non_const_nelr))]) = (-1); }
(__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements[(i + (j * __cuda_local_var_36012_6_non_const_nelr))])--; {

 int k;
# 456 "euler3d.cu"
k = 0; for (; (k < 3); k++)
{
_ZNSirsERf((((struct _ZSi *)&__cuda_local_var_36019_17_non_const_file)), (__cuda_local_var_36026_10_non_const_h_normals + (i + ((j + (k * 4)) * __cuda_local_var_36012_6_non_const_nelr))));
(__cuda_local_var_36026_10_non_const_h_normals[(i + ((j + (k * 4)) * __cuda_local_var_36012_6_non_const_nelr))]) = (-(__cuda_local_var_36026_10_non_const_h_normals[(i + ((j + (k * 4)) * __cuda_local_var_36012_6_non_const_nelr))]));
} }
} }
} }


__cuda_local_var_36048_7_non_const_last = (__cuda_local_var_36011_6_non_const_nel - 1); {
 int i;
# 466 "euler3d.cu"
i = __cuda_local_var_36011_6_non_const_nel; for (; (i < __cuda_local_var_36012_6_non_const_nelr); i++)
{
(__cuda_local_var_36024_10_non_const_h_areas[i]) = (__cuda_local_var_36024_10_non_const_h_areas[__cuda_local_var_36048_7_non_const_last]); {
 int j;
# 469 "euler3d.cu"
j = 0; for (; (j < 4); j++)
{

(__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements[(i + (j * __cuda_local_var_36012_6_non_const_nelr))]) = (__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements[(__cuda_local_var_36048_7_non_const_last + (j * __cuda_local_var_36012_6_non_const_nelr))]); {
 int k;
# 473 "euler3d.cu"
k = 0; for (; (k < 3); k++) { (__cuda_local_var_36026_10_non_const_h_normals[(__cuda_local_var_36048_7_non_const_last + ((j + (k * 4)) * __cuda_local_var_36012_6_non_const_nelr))]) = (__cuda_local_var_36026_10_non_const_h_normals[(__cuda_local_var_36048_7_non_const_last + ((j + (k * 4)) * __cuda_local_var_36012_6_non_const_nelr))]); } }
} }
} }

__cuda_local_var_36015_9_non_const_areas = (_Z5allocIfEPT_i(__cuda_local_var_36012_6_non_const_nelr));

__cuda_local_var_36016_7_non_const_elements_surrounding_elements = (_Z5allocIiEPT_i((__cuda_local_var_36012_6_non_const_nelr * 4)));

__cuda_local_var_36017_9_non_const_normals = (_Z5allocIfEPT_i(((__cuda_local_var_36012_6_non_const_nelr * 3) * 4)));
# 487 "euler3d.cu"
m5_work_begin(0UL, 0UL);

{ (__cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x.x) = (((__cuda_local_var_35989_10_non_const_ff_velocity.x) * (__cuda_local_var_36000_10_non_const_h_ff_momentum.x)) + __cuda_local_var_35985_9_non_const_ff_pressure); (__cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x.y) = ((__cuda_local_var_35989_10_non_const_ff_velocity.x) * (__cuda_local_var_36000_10_non_const_h_ff_momentum.y)); (__cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x.z) = ((__cuda_local_var_35989_10_non_const_ff_velocity.x) * (__cuda_local_var_36000_10_non_const_h_ff_momentum.z)); (__cuda_local_var_36005_10_non_const_h_ff_flux_contribution_momentum_y.x) = (__cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x.y); (__cuda_local_var_36005_10_non_const_h_ff_flux_contribution_momentum_y.y) = (((__cuda_local_var_35989_10_non_const_ff_velocity.y) * (__cuda_local_var_36000_10_non_const_h_ff_momentum.y)) + __cuda_local_var_35985_9_non_const_ff_pressure); (__cuda_local_var_36005_10_non_const_h_ff_flux_contribution_momentum_y.z) = ((__cuda_local_var_35989_10_non_const_ff_velocity.y) * (__cuda_local_var_36000_10_non_const_h_ff_momentum.z)); (__cuda_local_var_36006_10_non_const_h_ff_flux_contribution_momentum_z.x) = (__cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x.z); (__cuda_local_var_36006_10_non_const_h_ff_flux_contribution_momentum_z.y) = (__cuda_local_var_36005_10_non_const_h_ff_flux_contribution_momentum_y.z); (__cuda_local_var_36006_10_non_const_h_ff_flux_contribution_momentum_z.z) = (((__cuda_local_var_35989_10_non_const_ff_velocity.z) * (__cuda_local_var_36000_10_non_const_h_ff_momentum.z)) + __cuda_local_var_35985_9_non_const_ff_pressure); __T28 = ((*((__cuda_local_var_35980_9_non_const_h_ff_variable) + 4)) + __cuda_local_var_35985_9_non_const_ff_pressure); (__cuda_local_var_36007_10_non_const_h_ff_flux_contribution_density_energy.x) = ((__cuda_local_var_35989_10_non_const_ff_velocity.x) * __T28); (__cuda_local_var_36007_10_non_const_h_ff_flux_contribution_density_energy.y) = ((__cuda_local_var_35989_10_non_const_ff_velocity.y) * __T28); (__cuda_local_var_36007_10_non_const_h_ff_flux_contribution_density_energy.z) = ((__cuda_local_var_35989_10_non_const_ff_velocity.z) * __T28); }


{  enum cudaError __cuda_local_var_36075_14_non_const_err;
# 492 "euler3d.cu"
__cuda_local_var_36075_14_non_const_err = (_Z18cudaMemcpyToSymbolIA5_fE9cudaErrorRKT_PKvmm14cudaMemcpyKind(((const float (*)[5])ff_variable), ((const void *)(__cuda_local_var_35980_9_non_const_h_ff_variable)), 20UL, 0UL, cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_36075_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 492, (cudaGetErrorString(__cuda_local_var_36075_14_non_const_err))); exit(1); } } ; ;
{  enum cudaError __cuda_local_var_36076_14_non_const_err;
# 493 "euler3d.cu"
__cuda_local_var_36076_14_non_const_err = (_Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind(((const float3 (*)[1])ff_flux_contribution_momentum_x), ((const void *)(&__cuda_local_var_36004_10_non_const_h_ff_flux_contribution_momentum_x)), 12UL, 0UL, cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_36076_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 493, (cudaGetErrorString(__cuda_local_var_36076_14_non_const_err))); exit(1); } } ; ;
{  enum cudaError __cuda_local_var_36077_14_non_const_err;
# 494 "euler3d.cu"
__cuda_local_var_36077_14_non_const_err = (_Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind(((const float3 (*)[1])ff_flux_contribution_momentum_y), ((const void *)(&__cuda_local_var_36005_10_non_const_h_ff_flux_contribution_momentum_y)), 12UL, 0UL, cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_36077_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 494, (cudaGetErrorString(__cuda_local_var_36077_14_non_const_err))); exit(1); } } ; ;
{  enum cudaError __cuda_local_var_36078_14_non_const_err;
# 495 "euler3d.cu"
__cuda_local_var_36078_14_non_const_err = (_Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind(((const float3 (*)[1])ff_flux_contribution_momentum_z), ((const void *)(&__cuda_local_var_36006_10_non_const_h_ff_flux_contribution_momentum_z)), 12UL, 0UL, cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_36078_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 495, (cudaGetErrorString(__cuda_local_var_36078_14_non_const_err))); exit(1); } } ; ;

{  enum cudaError __cuda_local_var_36080_14_non_const_err;
# 497 "euler3d.cu"
__cuda_local_var_36080_14_non_const_err = (_Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind(((const float3 (*)[1])ff_flux_contribution_density_energy), ((const void *)(&__cuda_local_var_36007_10_non_const_h_ff_flux_contribution_density_energy)), 12UL, 0UL, cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_36080_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 497, (cudaGetErrorString(__cuda_local_var_36080_14_non_const_err))); exit(1); } } ; ;

_Z6uploadIfEvPT_S1_i(__cuda_local_var_36015_9_non_const_areas, __cuda_local_var_36024_10_non_const_h_areas, __cuda_local_var_36012_6_non_const_nelr);
_Z6uploadIiEvPT_S1_i(__cuda_local_var_36016_7_non_const_elements_surrounding_elements, __cuda_local_var_36025_8_non_const_h_elements_surrounding_elements, (__cuda_local_var_36012_6_non_const_nelr * 4));
_Z6uploadIfEvPT_S1_i(__cuda_local_var_36017_9_non_const_normals, __cuda_local_var_36026_10_non_const_h_normals, ((__cuda_local_var_36012_6_non_const_nelr * 3) * 4));


__cuda_local_var_36087_9_non_const_variables = (_Z5allocIfEPT_i((__cuda_local_var_36012_6_non_const_nelr * 5)));
_Z20initialize_variablesiPf(__cuda_local_var_36012_6_non_const_nelr, __cuda_local_var_36087_9_non_const_variables);

__cuda_local_var_36090_9_non_const_old_variables = (_Z5allocIfEPT_i((__cuda_local_var_36012_6_non_const_nelr * 5)));
__cuda_local_var_36091_9_non_const_fluxes = (_Z5allocIfEPT_i((__cuda_local_var_36012_6_non_const_nelr * 5)));
__cuda_local_var_36092_9_non_const_step_factors = (_Z5allocIfEPT_i(__cuda_local_var_36012_6_non_const_nelr));


_Z20initialize_variablesiPf(__cuda_local_var_36012_6_non_const_nelr, __cuda_local_var_36090_9_non_const_old_variables);
_Z20initialize_variablesiPf(__cuda_local_var_36012_6_non_const_nelr, __cuda_local_var_36091_9_non_const_fluxes);
cudaMemset(((void *)__cuda_local_var_36092_9_non_const_step_factors), 0, (4UL * ((unsigned long)__cuda_local_var_36012_6_non_const_nelr)));
...
__cuda_local_var_36105_15_non_const_timer = 0U;
if (1 != ((int)(cutCreateTimer((&__cuda_local_var_36105_15_non_const_timer))))) { fprintf(stderr, ((const char *)"Cut error in file \'%s\' in line %i.\n"), ((const char *)("euler3d.cu")), 523); exit(1); } ;
if (1 != ((int)(cutStartTimer(__cuda_local_var_36105_15_non_const_timer)))) { fprintf(stderr, ((const char *)"Cut error in file \'%s\' in line %i.\n"), ((const char *)("euler3d.cu")), 524); exit(1); } ; {


 int i;
# 527 "euler3d.cu"
i = 0; for (; (((unsigned)i) < iterations); i++)
{
_Z4copyIfEvPT_S1_i(__cuda_local_var_36090_9_non_const_old_variables, __cuda_local_var_36087_9_non_const_variables, (__cuda_local_var_36012_6_non_const_nelr * 5));


_Z19compute_step_factoriPfS_S_(__cuda_local_var_36012_6_non_const_nelr, __cuda_local_var_36087_9_non_const_variables, __cuda_local_var_36015_9_non_const_areas, __cuda_local_var_36092_9_non_const_step_factors);
{  cudaError_t __cuda_local_var_36116_17_non_const_err;
# 533 "euler3d.cu"
__cuda_local_var_36116_17_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_36116_17_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("compute_step_factor failed")), ((const char *)("euler3d.cu")), 533, (cudaGetErrorString(__cuda_local_var_36116_17_non_const_err))); exit(1); } } ; {

 int j;
# 535 "euler3d.cu"
j = 0; for (; (j < 3); j++)
{
_Z12compute_fluxiPiPfS0_S0_(__cuda_local_var_36012_6_non_const_nelr, __cuda_local_var_36016_7_non_const_elements_surrounding_elements, __cuda_local_var_36017_9_non_const_normals, __cuda_local_var_36087_9_non_const_variables, __cuda_local_var_36091_9_non_const_fluxes);
{  cudaError_t __cuda_local_var_36121_18_non_const_err;
# 538 "euler3d.cu"
__cuda_local_var_36121_18_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_36121_18_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("compute_flux failed")), ((const char *)("euler3d.cu")), 538, (cudaGetErrorString(__cuda_local_var_36121_18_non_const_err))); exit(1); } } ;
_Z9time_stepiiPfS_S_S_(j, __cuda_local_var_36012_6_non_const_nelr, __cuda_local_var_36090_9_non_const_old_variables, __cuda_local_var_36087_9_non_const_variables, __cuda_local_var_36092_9_non_const_step_factors, __cuda_local_var_36091_9_non_const_fluxes);
{  cudaError_t __cuda_local_var_36123_18_non_const_err;
# 540 "euler3d.cu"
__cuda_local_var_36123_18_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_36123_18_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("time_step failed")), ((const char *)("euler3d.cu")), 540, (cudaGetErrorString(__cuda_local_var_36123_18_non_const_err))); exit(1); } } ;
} }
} }
...
if (1 != ((int)(cutStopTimer(__cuda_local_var_36105_15_non_const_timer)))) { fprintf(stderr, ((const char *)"Cut error in file \'%s\' in line %i.\n"), ((const char *)("euler3d.cu")), 548); exit(1); } ;

_ZNSolsEPFRSoS_E((_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc((_ZNSolsEd((&_ZSt4cout), ((((double)(cutGetAverageTimerValue(__cuda_local_var_36105_15_non_const_timer))) / (1000.0)) / ((double)iterations)))), ((const char *)" seconds per iteration"))), _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_);
...
_Z4dumpPfii(__cuda_local_var_36087_9_non_const_variables, __cuda_local_var_36011_6_non_const_nel, __cuda_local_var_36012_6_non_const_nelr);
...
_ZdaPv(((void *)__cuda_local_var_36024_10_non_const_h_areas));
_ZdaPv(((void *)__cuda_local_var_36025_8_non_const_h_elements_surrounding_elements));
_ZdaPv(((void *)__cuda_local_var_36026_10_non_const_h_normals));



_Z7deallocIfEvPT_(__cuda_local_var_36015_9_non_const_areas);
_Z7deallocIiEvPT_(__cuda_local_var_36016_7_non_const_elements_surrounding_elements);
_Z7deallocIfEvPT_(__cuda_local_var_36017_9_non_const_normals);

_Z7deallocIfEvPT_(__cuda_local_var_36087_9_non_const_variables);
_Z7deallocIfEvPT_(__cuda_local_var_36090_9_non_const_old_variables);
_Z7deallocIfEvPT_(__cuda_local_var_36091_9_non_const_fluxes);
_Z7deallocIfEvPT_(__cuda_local_var_36092_9_non_const_step_factors);
...
_ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev((&__cuda_local_var_36019_17_non_const_file)); return 0; }
}
# 54 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z5allocIfEPT_i */ float *_Z5allocIfEPT_i( int N)
{
 float *__cuda_local_var_35639_5_non_const_t;
{  enum cudaError __cuda_local_var_35640_14_non_const_err;
# 57 "euler3d.cu"
__cuda_local_var_35640_14_non_const_err = (cudaMalloc(((void **)(&__cuda_local_var_35639_5_non_const_t)), (4UL * ((unsigned long)N)))); if (0 != ((int)__cuda_local_var_35640_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 57, (cudaGetErrorString(__cuda_local_var_35640_14_non_const_err))); exit(1); } } ; ;
return __cuda_local_var_35639_5_non_const_t;
}
# 54 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z5allocIiEPT_i */ int *_Z5allocIiEPT_i( int N)
{
 int *__cuda_local_var_35639_5_non_const_t;
{  enum cudaError __cuda_local_var_35640_14_non_const_err;
# 57 "euler3d.cu"
__cuda_local_var_35640_14_non_const_err = (cudaMalloc(((void **)(&__cuda_local_var_35639_5_non_const_t)), (4UL * ((unsigned long)N)))); if (0 != ((int)__cuda_local_var_35640_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 57, (cudaGetErrorString(__cuda_local_var_35640_14_non_const_err))); exit(1); } } ; ;
return __cuda_local_var_35639_5_non_const_t;
...
# 301 "/home/bachelor/deicide218/cuda-4.2/include/cuda_runtime.h"
 __attribute__((__weak__)) /* COMDAT group: _Z18cudaMemcpyToSymbolIA5_fE9cudaErrorRKT_PKvmm14cudaMemcpyKind */ __inline__ cudaError_t _Z18cudaMemcpyToSymbolIA5_fE9cudaErrorRKT_PKvmm14cudaMemcpyKind(
const float (*symbol)[5], 
const void *src, 
size_t count, 
size_t offset, 
...
# 301 "/home/bachelor/deicide218/cuda-4.2/include/cuda_runtime.h"
 __attribute__((__weak__)) /* COMDAT group: _Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind */ __inline__ cudaError_t _Z18cudaMemcpyToSymbolIA1_6float3E9cudaErrorRKT_PKvmm14cudaMemcpyKind(
const float3 (*symbol)[1], 
const void *src, 
size_t count, 
size_t offset, 
enum cudaMemcpyKind kind)
...
# 74 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z6uploadIfEvPT_S1_i */ void _Z6uploadIfEvPT_S1_i( float *dst,  float *src,  int N)
{
{  enum cudaError __cuda_local_var_35659_14_non_const_err;
# 76 "euler3d.cu"
__cuda_local_var_35659_14_non_const_err = (cudaMemcpy(((void *)dst), ((const void *)((void *)src)), (((unsigned long)N) * 4UL), cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_35659_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 76, (cudaGetErrorString(__cuda_local_var_35659_14_non_const_err))); exit(1); } } ; ; 
}
# 74 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z6uploadIiEvPT_S1_i */ void _Z6uploadIiEvPT_S1_i( int *dst,  int *src,  int N)
{
{  enum cudaError __cuda_local_var_35659_14_non_const_err;
# 76 "euler3d.cu"
__cuda_local_var_35659_14_non_const_err = (cudaMemcpy(((void *)dst), ((const void *)((void *)src)), (((unsigned long)N) * 4UL), cudaMemcpyHostToDevice)); if (0 != ((int)__cuda_local_var_35659_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 76, (cudaGetErrorString(__cuda_local_var_35659_14_non_const_err))); exit(1); } } ; ; 
...
# 68 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z4copyIfEvPT_S1_i */ void _Z4copyIfEvPT_S1_i( float *dst,  float *src,  int N)
{
{  enum cudaError __cuda_local_var_35653_14_non_const_err;
# 70 "euler3d.cu"
__cuda_local_var_35653_14_non_const_err = (cudaMemcpy(((void *)dst), ((const void *)((void *)src)), (((unsigned long)N) * 4UL), cudaMemcpyDeviceToDevice)); if (0 != ((int)__cuda_local_var_35653_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 70, (cudaGetErrorString(__cuda_local_var_35653_14_non_const_err))); exit(1); } } ; ; 
}
# 62 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z7deallocIfEvPT_ */ void _Z7deallocIfEvPT_( float *array)
{
{  enum cudaError __cuda_local_var_35647_14_non_const_err;
# 64 "euler3d.cu"
__cuda_local_var_35647_14_non_const_err = (cudaFree(((void *)array))); if (0 != ((int)__cuda_local_var_35647_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 64, (cudaGetErrorString(__cuda_local_var_35647_14_non_const_err))); exit(1); } } ; ; 
}
# 62 "euler3d.cu"
 __attribute__((__weak__)) /* COMDAT group: _Z7deallocIiEvPT_ */ void _Z7deallocIiEvPT_( int *array)
{
{  enum cudaError __cuda_local_var_35647_14_non_const_err;
# 64 "euler3d.cu"
__cuda_local_var_35647_14_non_const_err = (cudaFree(((void *)array))); if (0 != ((int)__cuda_local_var_35647_14_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error in file \'%s\' in line %i : %s.\n"), ((const char *)("euler3d.cu")), 64, (cudaGetErrorString(__cuda_local_var_35647_14_non_const_err))); exit(1); } } ; ; 
...
__asm__(".align 2");
# 101 "/usr/include/c++/4.4/istream" 3
extern __inline__ __attribute__((visibility("default"))) void _ZNSiD2Ev( struct _ZSi *const this,  const long *const *__T211)
{  (this->__vptr) = (*__T211); ((((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)this) + ((this->__vptr)[(-3L)])))->__b_St8ios_base).__vptr) = (*(__T211 + 1UL)); (this->_M_gcount) = 0L;  }
__asm__(".align 2");
extern __inline__ __attribute__((visibility("default"))) void _ZNSiD0Ev( struct _ZSi *const this) {  const long *const *__T212;
if (this) { ((__T212 = (_ZTTSi)) , (void)(_ZNSiD2Ev(this, __T212))) , (void)(_ZNSt9basic_iosIcSt11char_traitsIcEED1Ev((&(this->__v_St9basic_iosIcSt11char_traitsIcEE)))); _ZdlPv(((void *)this)); }  }
__asm__(".align 2");
extern __inline__ __attribute__((visibility("default"))) void _ZNSiD1Ev( struct _ZSi *const this) {  const long *const *__T213;
__T213 = (_ZTTSi); _ZNSiD2Ev(this, __T213);
...
__asm__(".align 2");
# 454 "/usr/include/c++/4.4/fstream" 3
extern __inline__ __attribute__((visibility("default"))) void _ZNSt14basic_ifstreamIcSt11char_traitsIcEEC2EPKcSt13_Ios_Openmode( struct _ZSt14basic_ifstreamIcSt11char_traitsIcEE *const this,  const long *const *__T214,  const char *__s,  _ZNSt8ios_base8openmodeE __mode)

{  struct _ZSt9basic_iosIcSt11char_traitsIcEE *__T215;
# 456 "/usr/include/c++/4.4/fstream" 3
{ (((struct _ZSi *)this)->__vptr) = (*(__T214 + 1UL)); ((((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)((struct _ZSi *)this)) + ((((struct _ZSi *)this)->__vptr)[(-3L)])))->__b_St8ios_base).__vptr) = (*((__T214 + 1UL) + 1UL)); (((struct _ZSi *)this)->_M_gcount) = 0L; _ZNSt9basic_iosIcSt11char_traitsIcEE4initEPSt15basic_streambufIcS1_E(((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)((struct _ZSi *)this)) + ((((struct _ZSi *)this)->__vptr)[(-3L)]))), ((struct _ZSt15basic_streambufIcSt11char_traitsIcEE *)0LL)); } ((this->__b_Si).__vptr) = (*__T214); ((((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)this) + (((this->__b_Si).__vptr)[(-3L)])))->__b_St8ios_base).__vptr) = (*(__T214 + 3UL)); _ZNSt13basic_filebufIcSt11char_traitsIcEEC1Ev((&(this->_M_filebuf)));
...
{ if (!(_ZNSt13basic_filebufIcSt11char_traitsIcEE4openEPKcSt13_Ios_Openmode((&(this->_M_filebuf)), __s, ((enum _ZSt13_Ios_Openmode)(((int)__mode) | ((int)_ZSt5_S_in)))))) { { __T215 = ((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)this) + (((this->__b_Si).__vptr)[(-3L)]))); { _ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate(__T215, ((enum _ZSt12_Ios_Iostate)(((int)((((const struct _ZSt9basic_iosIcSt11char_traitsIcEE *)__T215)->__b_St8ios_base)._M_streambuf_state)) | ((int)((_ZNSt8ios_base7iostateE)4))))); } } } else  { _ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate(((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)this) + (((this->__b_Si).__vptr)[(-3L)]))), ((_ZNSt8ios_base7iostateE)0)); } } 
}
__asm__(".align 2");
extern __inline__ __attribute__((visibility("default"))) void _ZNSt14basic_ifstreamIcSt11char_traitsIcEEC1EPKcSt13_Ios_Openmode( struct _ZSt14basic_ifstreamIcSt11char_traitsIcEE *const this,  const char *__T216,  _ZNSt8ios_base8openmodeE __T217) {  const long *const *__T218;
__T218 = (_ZTTSt14basic_ifstreamIcSt11char_traitsIcEE); ((this->__b_Si).__vptr) = (*__T218);
# 456 "/usr/include/c++/4.4/fstream" 3
{ _ZNSt9basic_iosIcSt11char_traitsIcEEC1Ev((&(this->__v_St9basic_iosIcSt11char_traitsIcEE))); } _ZNSt14basic_ifstreamIcSt11char_traitsIcEEC2EPKcSt13_Ios_Openmode(this, __T218, __T216, __T217);  }
__asm__(".align 2");
# 485 "/usr/include/c++/4.4/fstream" 3
extern __inline__ __attribute__((visibility("default"))) void _ZNSt14basic_ifstreamIcSt11char_traitsIcEED2Ev( struct _ZSt14basic_ifstreamIcSt11char_traitsIcEE *const this,  const long *const *__T219)
{  ((this->__b_Si).__vptr) = (*__T219); ((((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)this) + (((this->__b_Si).__vptr)[(-3L)])))->__b_St8ios_base).__vptr) = (*(__T219 + 3UL)); { { (((this->_M_filebuf).__b_St15basic_streambufIcSt11char_traitsIcEE).__vptr) = (_ZTVSt13basic_filebufIcSt11char_traitsIcEE + 2); _ZNSt13basic_filebufIcSt11char_traitsIcEE5closeEv((&(this->_M_filebuf))); { _ZNSt12__basic_fileIcED1Ev((&((this->_M_filebuf)._M_file))); { _ZNSt15basic_streambufIcSt11char_traitsIcEED1Ev((&((this->_M_filebuf).__b_St15basic_streambufIcSt11char_traitsIcEE))); } } } { (((struct _ZSi *)this)->__vptr) = (*(__T219 + 1UL)); ((((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)((struct _ZSi *)this)) + ((((struct _ZSi *)this)->__vptr)[(-3L)])))->__b_St8ios_base).__vptr) = (*((__T219 + 1UL) + 1UL)); (((struct _ZSi *)this)->_M_gcount) = 0L; } }  }
__asm__(".align 2");
extern __inline__ __attribute__((visibility("default"))) void _ZNSt14basic_ifstreamIcSt11char_traitsIcEED0Ev( struct _ZSt14basic_ifstreamIcSt11char_traitsIcEE *const this) {  const long *const *__T220;
if (this) { ((__T220 = (_ZTTSt14basic_ifstreamIcSt11char_traitsIcEE)) , (void)(_ZNSt14basic_ifstreamIcSt11char_traitsIcEED2Ev(this, __T220))) , (void)(_ZNSt9basic_iosIcSt11char_traitsIcEED1Ev((&(this->__v_St9basic_iosIcSt11char_traitsIcEE)))); _ZdlPv(((void *)this)); }  }
__asm__(".align 2");
extern __inline__ __attribute__((visibility("default"))) void _ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev( struct _ZSt14basic_ifstreamIcSt11char_traitsIcEE *const this) {  const long *const *__T221;
__T221 = (_ZTTSt14basic_ifstreamIcSt11char_traitsIcEE); _ZNSt14basic_ifstreamIcSt11char_traitsIcEED2Ev(this, __T221);
...
{  const struct _ZSt9basic_iosIcSt11char_traitsIcEE *__T222;
 const _ZNSt9basic_iosIcSt11char_traitsIcEE12__ctype_typeE *__T223;
 struct _ZSo *__T224;
# 539 "/usr/include/c++/4.4/ostream" 3
return (__T224 = (_ZNSo3putEc(__os, ((__T222 = ((const struct _ZSt9basic_iosIcSt11char_traitsIcEE *)((__os) ? ((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)__os) + ((__os->__vptr)[(-3L)]))) : ((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)0LL)))) , (_ZNKSt5ctypeIcE5widenEc(((__T223 = (__T222->_M_ctype)) , (((!(__T223)) ? (_ZSt16__throw_bad_castv()) : ((void)0)) , __T223)), ((char)10))))))) , (_ZNSo5flushEv(__T224)); }
# 505 "/usr/include/c++/4.4/ostream" 3
...
if (!(__s)) {
{ __T225 = ((__out) ? ((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)(((char *)__out) + ((__out->__vptr)[(-3L)]))) : ((struct _ZSt9basic_iosIcSt11char_traitsIcEE *)0LL)); { _ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate(__T225, ((enum _ZSt12_Ios_Iostate)(((int)((((const struct _ZSt9basic_iosIcSt11char_traitsIcEE *)__T225)->__b_St8ios_base)._M_streambuf_state)) | ((int)((_ZNSt8ios_base7iostateE)1))))); } } } else  {
...
static void __sti___15_euler3d_cpp1_ii_78e67203(void) {
# 72 "/usr/include/c++/4.4/iostream" 3
