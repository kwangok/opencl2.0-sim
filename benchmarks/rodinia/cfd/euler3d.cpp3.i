...
# 128 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z25cuda_initialize_variablesiPf(int, float *);
# 184 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z24cuda_compute_step_factoriPfS_S_(int, float *, float *, float *);
# 215 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z17cuda_compute_fluxiPiPfS0_S0_(int, int *, float *, float *, float *);
# 352 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z14cuda_time_stepiiPfS_S_S_(int, int, float *, float *, float *, float *);
# 122 "euler3d.cu"
static __attribute__((__used__)) __attribute__((constant)) float ff_variable[5];
# 123 "euler3d.cu"
static __attribute__((__used__)) __attribute__((constant)) float3 ff_flux_contribution_momentum_x[1];
# 124 "euler3d.cu"
static __attribute__((__used__)) __attribute__((constant)) float3 ff_flux_contribution_momentum_y[1];
# 125 "euler3d.cu"
static __attribute__((__used__)) __attribute__((constant)) float3 ff_flux_contribution_momentum_z[1];
# 126 "euler3d.cu"
static __attribute__((__used__)) __attribute__((constant)) float3 ff_flux_contribution_density_energy[1];
...
# 128 "euler3d.cu" 2
# 128 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) void _Z25cuda_initialize_variablesiPf(
# 128 "euler3d.cu"
int nelr,
# 128 "euler3d.cu"
float *variables){
...
# 184 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) void _Z24cuda_compute_step_factoriPfS_S_(
# 184 "euler3d.cu"
int nelr,
# 184 "euler3d.cu"
float *variables,
...
# 215 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) void _Z17cuda_compute_fluxiPiPfS0_S0_(
# 215 "euler3d.cu"
int nelr,
# 215 "euler3d.cu"
...
# 352 "euler3d.cu"
__attribute__((global)) __attribute__((__used__)) void _Z14cuda_time_stepiiPfS_S_S_(
# 352 "euler3d.cu"
int j,
# 352 "euler3d.cu"
int nelr,
