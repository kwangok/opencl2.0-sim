...
# 105 "hotspot.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z14calculate_tempiPfS_S_iiiiffffff(int, float *, float *, float *, int, int, int, int, float, float, float, float, float, float);
...
# 107 "hotspot.cu" 2
# 105 "hotspot.cu"
__attribute__((global)) __attribute__((__used__)) void _Z14calculate_tempiPfS_S_iiiiffffff(
# 105 "hotspot.cu"
int iteration,
# 106 "hotspot.cu"
float *power,
...
{
# 120 "hotspot.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_16455_39_non_const_temp_on_cuda[16][16];
# 121 "hotspot.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_16456_39_non_const_power_on_cuda[16][16];
# 122 "hotspot.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_16457_39_non_const_temp_t[16][16];
# 124 "hotspot.cu"
