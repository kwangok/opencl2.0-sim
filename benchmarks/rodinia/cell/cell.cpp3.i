...
# 74 "cell.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z6evolveiPiS_iiiiiiiii(int, int *, int *, int, int, int, int, int, int, int, int, int);
...
# 76 "cell.cu" 2
# 74 "cell.cu"
__attribute__((global)) __attribute__((__used__)) void _Z6evolveiPiS_iiiiiiiii(
# 75 "cell.cu"
int iteration,
# 76 "cell.cu"
int *gpuDataSrc,
...
{
# 83 "cell.cu"
static __attribute__((__used__)) __attribute__((shared)) int __cuda_local_var_16424_37_non_const_data[8][8][8];
# 84 "cell.cu"
static __attribute__((__used__)) __attribute__((shared)) int __cuda_local_var_16425_37_non_const_result[8][8][8];
# 86 "cell.cu"
