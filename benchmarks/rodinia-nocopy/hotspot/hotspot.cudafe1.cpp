...
{ 
# 120
__attribute__((unused)) static float temp_on_cuda[16][16]; 
# 121
__attribute__((unused)) static float power_on_cuda[16][16]; 
# 122
__attribute__((unused)) static float temp_t[16][16]; 
# 124
float amb_temp = ((80.0)); 
# 125
float step_div_Cap; 
...
m5_work_begin(0, 0); 
# 340
int ret = compute_tran_temp(FilesavingPower, FilesavingTemp, grid_cols, grid_rows, total_iterations, pyramid_height, blockCols, blockRows, borderCols, borderRows); 
# 346
m5_work_end(0, 0); 
# 349
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_hotspot_cpp4_ii_t_chip
# 1 "hotspot.cudafe1.stub.c"
