...
# 68
std::vector< latLong, std::allocator< latLong> >  vlocations; 
# 69
char filename[512]; 
# 70
int resultsCount = 10; 
...
# 121
cudaConfigureCall(dimGrid, dimBlock) ? ((void)0) : euclid(locations, distances, numRecords, lat, lng); 
# 122
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_nn_cuda_cpp4_ii_4c3be9ae
# 1 "nn_cuda.cudafe1.stub.c"
