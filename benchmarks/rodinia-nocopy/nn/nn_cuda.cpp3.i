...
# 45 "nn_cuda.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z6euclidP7latLongPfiff(LatLong *, float *, int, float, float);
...
# 47 "nn_cuda.cu" 2
# 45 "nn_cuda.cu"
__attribute__((global)) __attribute__((__used__)) void _Z6euclidP7latLongPfiff(
# 45 "nn_cuda.cu"
LatLong *d_locations,
# 45 "nn_cuda.cu"
float *d_distances,
