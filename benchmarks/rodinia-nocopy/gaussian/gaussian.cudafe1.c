...
# 104 "gaussian.cu"
 struct timeval __cuda_local_var_17658_20_non_const_time_end;

 unsigned __cuda_local_var_17660_18_non_const_time_total;
# 54 "gaussian.cu"
...
gettimeofday((&__cuda_local_var_17658_20_non_const_time_end), ((struct timezone *)0LL));
__cuda_local_var_17660_18_non_const_time_total = ((unsigned)((((__cuda_local_var_17658_20_non_const_time_end.tv_sec) * 1000000L) + (__cuda_local_var_17658_20_non_const_time_end.tv_usec)) - (((__cuda_local_var_17643_20_non_const_time_start.tv_sec) * 1000000L) + (__cuda_local_var_17643_20_non_const_time_start.tv_usec))));

if (__cuda_local_var_17608_9_non_const_verbose) {
printf(((const char *)"Matrix m is: \n"));
_Z8PrintMatPfii(m, Size, Size);

printf(((const char *)"Matrix a is: \n"));
_Z8PrintMatPfii(a, Size, Size);

printf(((const char *)"Array b is: \n"));
_Z8PrintAryPfi(b, Size);
}
_Z7BackSubv();
if (__cuda_local_var_17608_9_non_const_verbose) {
...
printf(((const char *)"\nTime total (including memory transfers)\t%f sec\n"), (((double)__cuda_local_var_17660_18_non_const_time_total) * (9.999999999999999547e-07)));
...
void _Z21PrintDevicePropertiesv(void) {
 struct cudaDeviceProp __cuda_local_var_17692_17_non_const_deviceProp;
 int __cuda_local_var_17693_6_non_const_nDevCount;
# 139 "gaussian.cu"
__cuda_local_var_17693_6_non_const_nDevCount = 0;

cudaGetDeviceCount((&__cuda_local_var_17693_6_non_const_nDevCount));
printf(((const char *)"Total Device found: %d"), __cuda_local_var_17693_6_non_const_nDevCount); {
 int nDeviceIdx;
# 143 "gaussian.cu"
nDeviceIdx = 0; for (; (nDeviceIdx < __cuda_local_var_17693_6_non_const_nDevCount); ++nDeviceIdx)
{
memset(((void *)(&__cuda_local_var_17692_17_non_const_deviceProp)), 0, 568UL);
if (0 == ((int)(cudaGetDeviceProperties((&__cuda_local_var_17692_17_non_const_deviceProp), nDeviceIdx))))
{
printf(((const char *)"\nDevice Name \t\t - %s "), ((__cuda_local_var_17692_17_non_const_deviceProp.name)));
printf(((const char *)"\n**************************************"));
printf(((const char *)"\nTotal Global Memory\t\t\t - %lu KB"), ((__cuda_local_var_17692_17_non_const_deviceProp.totalGlobalMem) / 1024UL));
printf(((const char *)"\nShared memory available per block \t - %lu KB"), ((__cuda_local_var_17692_17_non_const_deviceProp.sharedMemPerBlock) / 1024UL));
printf(((const char *)"\nNumber of registers per thread block \t - %d"), (__cuda_local_var_17692_17_non_const_deviceProp.regsPerBlock));
printf(((const char *)"\nWarp size in threads \t\t\t - %d"), (__cuda_local_var_17692_17_non_const_deviceProp.warpSize));
printf(((const char *)"\nMemory Pitch \t\t\t\t - %zu bytes"), (__cuda_local_var_17692_17_non_const_deviceProp.memPitch));
printf(((const char *)"\nMaximum threads per block \t\t - %d"), (__cuda_local_var_17692_17_non_const_deviceProp.maxThreadsPerBlock));
printf(((const char *)"\nMaximum Thread Dimension (block) \t - %d %d %d"), (((__cuda_local_var_17692_17_non_const_deviceProp.maxThreadsDim))[0]), (((__cuda_local_var_17692_17_non_const_deviceProp.maxThreadsDim))[1]), (((__cuda_local_var_17692_17_non_const_deviceProp.maxThreadsDim))[2]));
printf(((const char *)"\nMaximum Thread Dimension (grid) \t - %d %d %d"), (((__cuda_local_var_17692_17_non_const_deviceProp.maxGridSize))[0]), (((__cuda_local_var_17692_17_non_const_deviceProp.maxGridSize))[1]), (((__cuda_local_var_17692_17_non_const_deviceProp.maxGridSize))[2]));
printf(((const char *)"\nTotal constant memory \t\t\t - %zu bytes"), (__cuda_local_var_17692_17_non_const_deviceProp.totalConstMem));
printf(((const char *)"\nCUDA ver \t\t\t\t - %d.%d"), (__cuda_local_var_17692_17_non_const_deviceProp.major), (__cuda_local_var_17692_17_non_const_deviceProp.minor));
printf(((const char *)"\nClock rate \t\t\t\t - %d KHz"), (__cuda_local_var_17692_17_non_const_deviceProp.clockRate));
printf(((const char *)"\nTexture Alignment \t\t\t - %zu bytes"), (__cuda_local_var_17692_17_non_const_deviceProp.textureAlignment));
printf(((const char *)"\nDevice Overlap \t\t\t\t - %s"), ((__cuda_local_var_17692_17_non_const_deviceProp.deviceOverlap) ? ((const char *)("Allowed")) : ((const char *)("Not Allowed"))));
printf(((const char *)"\nNumber of Multi processors \t\t - %d\n\n"), (__cuda_local_var_17692_17_non_const_deviceProp.multiProcessorCount));
} else  {
...
{
 int __cuda_local_var_17757_6_non_const_i;
for (__cuda_local_var_17757_6_non_const_i = 0; (__cuda_local_var_17757_6_non_const_i < (Size * Size)); __cuda_local_var_17757_6_non_const_i++) {
(*(m + __cuda_local_var_17757_6_non_const_i)) = (0.0F); } 
}
# 262 "gaussian.cu"
...
{  unsigned __T20;
 ...
 unsigned __T25;
# 264 "gaussian.cu"
 int __cuda_local_var_17801_6_non_const_t;
# 279 "gaussian.cu"
 int __cuda_local_var_17803_6_non_const_block_size;
# 279 "gaussian.cu"
 int __cuda_local_var_17803_17_non_const_grid_size;
# 286 "gaussian.cu"
 dim3 __cuda_local_var_17810_7_non_const_dimBlock;
 dim3 __cuda_local_var_17811_7_non_const_dimGrid;


 int __cuda_local_var_17814_6_non_const_blockSize2d;
# 290 "gaussian.cu"
 int __cuda_local_var_17814_19_non_const_gridSize2d;



 dim3 __cuda_local_var_17818_7_non_const_dimBlockXY;
 dim3 __cuda_local_var_17819_7_non_const_dimGridXY;


 struct timeval __cuda_local_var_17822_20_non_const_time_start;
# 308 "gaussian.cu"
 struct timeval __cuda_local_var_17832_17_non_const_time_end;
# 281 "gaussian.cu"
__cuda_local_var_17803_6_non_const_block_size = 512;
__cuda_local_var_17803_17_non_const_grid_size = ((Size / __cuda_local_var_17803_6_non_const_block_size) + ((!(Size % __cuda_local_var_17803_6_non_const_block_size)) ? 0 : 1));



{ __T20 = ((unsigned)__cuda_local_var_17803_6_non_const_block_size); { (__cuda_local_var_17810_7_non_const_dimBlock.x) = __T20; (__cuda_local_var_17810_7_non_const_dimBlock.y) = 1U; (__cuda_local_var_17810_7_non_const_dimBlock.z) = 1U; } }
{ __T21 = ((unsigned)__cuda_local_var_17803_17_non_const_grid_size); { (__cuda_local_var_17811_7_non_const_dimGrid.x) = __T21; (__cuda_local_var_17811_7_non_const_dimGrid.y) = 1U; (__cuda_local_var_17811_7_non_const_dimGrid.z) = 1U; } }



__cuda_local_var_17814_6_non_const_blockSize2d = 4;
__cuda_local_var_17814_19_non_const_gridSize2d = ((Size / __cuda_local_var_17814_6_non_const_blockSize2d) + ((int)(!((Size % __cuda_local_var_17814_6_non_const_blockSize2d) ? 0 : 1))));

{ __T22 = ((unsigned)__cuda_local_var_17814_6_non_const_blockSize2d); __T23 = ((unsigned)__cuda_local_var_17814_6_non_const_blockSize2d); { (__cuda_local_var_17818_7_non_const_dimBlockXY.x) = __T22; (__cuda_local_var_17818_7_non_const_dimBlockXY.y) = __T23; (__cuda_local_var_17818_7_non_const_dimBlockXY.z) = 1U; } }
{ __T24 = ((unsigned)__cuda_local_var_17814_19_non_const_gridSize2d); __T25 = ((unsigned)__cuda_local_var_17814_19_non_const_gridSize2d); { (__cuda_local_var_17819_7_non_const_dimGridXY.x) = __T24; (__cuda_local_var_17819_7_non_const_dimGridXY.y) = __T25; (__cuda_local_var_17819_7_non_const_dimGridXY.z) = 1U; } }



gettimeofday((&__cuda_local_var_17822_20_non_const_time_start), ((struct timezone *)0LL));
for (__cuda_local_var_17801_6_non_const_t = 0; (__cuda_local_var_17801_6_non_const_t < (Size - 1)); __cuda_local_var_17801_6_non_const_t++) {
(cudaConfigureCall(__cuda_local_var_17811_7_non_const_dimGrid, __cuda_local_var_17810_7_non_const_dimBlock, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z4Fan1PfS_ii(m, a, Size, __cuda_local_var_17801_6_non_const_t));
cudaThreadSynchronize();
(cudaConfigureCall(__cuda_local_var_17819_7_non_const_dimGridXY, __cuda_local_var_17818_7_non_const_dimBlockXY, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z4Fan2PfS_S_iii(m, a, b, Size, (Size - __cuda_local_var_17801_6_non_const_t), __cuda_local_var_17801_6_non_const_t));
cudaThreadSynchronize();
_Z14checkCUDAErrorPKc(((const char *)"Fan2"));
}


gettimeofday((&__cuda_local_var_17832_17_non_const_time_end), ((struct timezone *)0LL));
totalKernelTime = ((unsigned)((((__cuda_local_var_17832_17_non_const_time_end.tv_sec) * 1000000L) + (__cuda_local_var_17832_17_non_const_time_end.tv_usec)) - (((__cuda_local_var_17822_20_non_const_time_start.tv_sec) * 1000000L) + (__cuda_local_var_17822_20_non_const_time_start.tv_usec)))); 
# 319 "gaussian.cu"
}
# 326 "gaussian.cu"
void _Z7BackSubv(void)
{
 ...
 int __cuda_local_var_17848_6_non_const_i;
# 331 "gaussian.cu"
 int __cuda_local_var_17848_8_non_const_j;
# 329 "gaussian.cu"
finalVec = ((float *)(malloc((((unsigned long)Size) * 4UL))));


for (__cuda_local_var_17848_6_non_const_i = 0; (__cuda_local_var_17848_6_non_const_i < Size); __cuda_local_var_17848_6_non_const_i++) {
(finalVec[((Size - __cuda_local_var_17848_6_non_const_i) - 1)]) = (b[((Size - __cuda_local_var_17848_6_non_const_i) - 1)]);
for (__cuda_local_var_17848_8_non_const_j = 0; (__cuda_local_var_17848_8_non_const_j < __cuda_local_var_17848_6_non_const_i); __cuda_local_var_17848_8_non_const_j++)
{
(finalVec[((Size - __cuda_local_var_17848_6_non_const_i) - 1)]) -= ((*((a + (Size * ((Size - __cuda_local_var_17848_6_non_const_i) - 1))) + ((Size - __cuda_local_var_17848_8_non_const_j) - 1))) * (finalVec[((Size - __cuda_local_var_17848_8_non_const_j) - 1)]));
}
(finalVec[((Size - __cuda_local_var_17848_6_non_const_i) - 1)]) = ((finalVec[((Size - __cuda_local_var_17848_6_non_const_i) - 1)]) / (*((a + (Size * ((Size - __cuda_local_var_17848_6_non_const_i) - 1))) + ((Size - __cuda_local_var_17848_6_non_const_i) - 1))));
} 
}

void _Z7InitMatPfii( float *ary,  int nrow,  int ncol)
{
 int __cuda_local_var_17861_6_non_const_i;
# 344 "gaussian.cu"
 int __cuda_local_var_17861_9_non_const_j;

for (__cuda_local_var_17861_6_non_const_i = 0; (__cuda_local_var_17861_6_non_const_i < nrow); __cuda_local_var_17861_6_non_const_i++) {
for (__cuda_local_var_17861_9_non_const_j = 0; (__cuda_local_var_17861_9_non_const_j < ncol); __cuda_local_var_17861_9_non_const_j++) {
fscanf(fp, ((const char *)"%f"), ((ary + (Size * __cuda_local_var_17861_6_non_const_i)) + __cuda_local_var_17861_9_non_const_j));
}
} 
}
...
{
 int __cuda_local_var_17876_6_non_const_i;
# 359 "gaussian.cu"
 int __cuda_local_var_17876_9_non_const_j;

for (__cuda_local_var_17876_6_non_const_i = 0; (__cuda_local_var_17876_6_non_const_i < nrow); __cuda_local_var_17876_6_non_const_i++) {
for (__cuda_local_var_17876_9_non_const_j = 0; (__cuda_local_var_17876_9_non_const_j < ncol); __cuda_local_var_17876_9_non_const_j++) {
printf(((const char *)"%8.2f "), ((double)(*((ary + (Size * __cuda_local_var_17876_6_non_const_i)) + __cuda_local_var_17876_9_non_const_j))));
}
printf(((const char *)"\n"));
}
printf(((const char *)"\n")); 
...
{
 int __cuda_local_var_17894_6_non_const_i;

for (__cuda_local_var_17894_6_non_const_i = 0; (__cuda_local_var_17894_6_non_const_i < ary_size); __cuda_local_var_17894_6_non_const_i++) {
fscanf(fp, ((const char *)"%f"), (ary + __cuda_local_var_17894_6_non_const_i));
} 
}
...
{
 int __cuda_local_var_17907_6_non_const_i;
for (__cuda_local_var_17907_6_non_const_i = 0; (__cuda_local_var_17907_6_non_const_i < ary_size); __cuda_local_var_17907_6_non_const_i++) {
printf(((const char *)"%.2f "), ((double)(ary[__cuda_local_var_17907_6_non_const_i])));
}
printf(((const char *)"\n\n")); 
}
void _Z14checkCUDAErrorPKc( const char *msg)
{
 cudaError_t __cuda_local_var_17915_17_non_const_err;
# 398 "gaussian.cu"
__cuda_local_var_17915_17_non_const_err = (cudaGetLastError());
if (0 != ((int)__cuda_local_var_17915_17_non_const_err))
{
fprintf(stderr, ((const char *)"Cuda error: %s: %s.\n"), msg, (cudaGetErrorString(__cuda_local_var_17915_17_non_const_err)));
