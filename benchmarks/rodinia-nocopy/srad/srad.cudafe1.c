...
# 55 "srad.cu"
 ...
 float *__cuda_local_var_17798_12_non_const_dN;
# 57 "srad.cu"
 float *__cuda_local_var_17798_16_non_const_dS;
# 57 "srad.cu"
 float *__cuda_local_var_17798_20_non_const_dW;
# 57 "srad.cu"
 float *__cuda_local_var_17798_24_non_const_dE;
# 72 "srad.cu"
 unsigned __cuda_local_var_17800_15_non_const_r1;
# 72 "srad.cu"
 unsigned __cuda_local_var_17800_19_non_const_r2;
# 72 "srad.cu"
 unsigned __cuda_local_var_17800_23_non_const_c1;
# 72 "srad.cu"
 unsigned __cuda_local_var_17800_27_non_const_c2;
 float *__cuda_local_var_17801_9_non_const_c;
# 54 "srad.cu"
...
__cuda_local_var_17800_15_non_const_r1 = ((unsigned)((__T22 = ((const char *)(argv[3]))) , ((int)(strtol(__T22, ((char **)0LL), 10)))));
__cuda_local_var_17800_19_non_const_r2 = ((unsigned)((__T23 = ((const char *)(argv[4]))) , ((int)(strtol(__T23, ((char **)0LL), 10)))));
__cuda_local_var_17800_23_non_const_c1 = ((unsigned)((__T24 = ((const char *)(argv[5]))) , ((int)(strtol(__T24, ((char **)0LL), 10)))));
__cuda_local_var_17800_27_non_const_c2 = ((unsigned)((__T25 = ((const char *)(argv[6]))) , ((int)(strtol(__T25, ((char **)0LL), 10)))));
...
__cuda_local_var_17795_29_non_const_size_R = ((int)(((__cuda_local_var_17800_19_non_const_r2 - __cuda_local_var_17800_15_non_const_r1) + 1U) * ((__cuda_local_var_17800_27_non_const_c2 - __cuda_local_var_17800_23_non_const_c1) + 1U)));
...
__cuda_local_var_17801_9_non_const_c = ((float *)(malloc((4UL * ((unsigned long)__cuda_local_var_17795_21_non_const_size_I)))));



__cuda_local_var_17798_12_non_const_dN = ((float *)(malloc((4UL * ((unsigned long)__cuda_local_var_17795_21_non_const_size_I)))));
__cuda_local_var_17798_16_non_const_dS = ((float *)(malloc((4UL * ((unsigned long)__cuda_local_var_17795_21_non_const_size_I)))));
__cuda_local_var_17798_20_non_const_dW = ((float *)(malloc((4UL * ((unsigned long)__cuda_local_var_17795_21_non_const_size_I)))));
__cuda_local_var_17798_24_non_const_dE = ((float *)(malloc((4UL * ((unsigned long)__cuda_local_var_17795_21_non_const_size_I)))));
# 149 "srad.cu"
...
for (__cuda_local_var_17795_49_non_const_iter = 0; (__cuda_local_var_17795_49_non_const_iter < __cuda_local_var_17795_37_non_const_niter); __cuda_local_var_17795_49_non_const_iter++) {  unsigned __T29;
 unsigned __T210;
# 233 "srad.cu"
 int __cuda_local_var_17865_6_non_const_block_x;
 int __cuda_local_var_17866_9_non_const_block_y;

 dim3 __cuda_local_var_17868_10_non_const_dimBlock;
 dim3 __cuda_local_var_17869_7_non_const_dimGrid;
# 161 "srad.cu"
__cuda_local_var_17796_34_non_const_sum = (0.0F); __cuda_local_var_17796_39_non_const_sum2 = (0.0F); {
 int i;
# 162 "srad.cu"
i = ((int)__cuda_local_var_17800_15_non_const_r1); for (; (((unsigned)i) <= __cuda_local_var_17800_19_non_const_r2); i++) { {
 int j;
# 163 "srad.cu"
j = ((int)__cuda_local_var_17800_23_non_const_c1); for (; (((unsigned)j) <= __cuda_local_var_17800_27_non_const_c2); j++) {
...
# 233 "srad.cu"
__cuda_local_var_17865_6_non_const_block_x = (__cuda_local_var_17795_15_non_const_cols / 16);
__cuda_local_var_17866_9_non_const_block_y = (__cuda_local_var_17795_9_non_const_rows / 16);

{ (__cuda_local_var_17868_10_non_const_dimBlock.x) = 16U; (__cuda_local_var_17868_10_non_const_dimBlock.y) = 16U; (__cuda_local_var_17868_10_non_const_dimBlock.z) = 1U; }
{ __T29 = ((unsigned)__cuda_local_var_17865_6_non_const_block_x); __T210 = ((unsigned)__cuda_local_var_17866_9_non_const_block_y); { (__cuda_local_var_17869_7_non_const_dimGrid.x) = __T29; (__cuda_local_var_17869_7_non_const_dimGrid.y) = __T210; (__cuda_local_var_17869_7_non_const_dimGrid.z) = 1U; } }
# 244 "srad.cu"
(cudaConfigureCall(__cuda_local_var_17869_7_non_const_dimGrid, __cuda_local_var_17868_10_non_const_dimBlock, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z11srad_cuda_1PfS_S_S_S_S_iif(__cuda_local_var_17798_24_non_const_dE, __cuda_local_var_17798_20_non_const_dW, __cuda_local_var_17798_12_non_const_dN, __cuda_local_var_17798_16_non_const_dS, __cuda_local_var_17796_16_non_const_J, __cuda_local_var_17801_9_non_const_c, __cuda_local_var_17795_15_non_const_cols, __cuda_local_var_17795_9_non_const_rows, __cuda_local_var_17796_27_non_const_q0sqr));
(cudaConfigureCall(__cuda_local_var_17869_7_non_const_dimGrid, __cuda_local_var_17868_10_non_const_dimBlock, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z11srad_cuda_2PfS_S_S_S_S_iiff(__cuda_local_var_17798_24_non_const_dE, __cuda_local_var_17798_20_non_const_dW, __cuda_local_var_17798_12_non_const_dN, __cuda_local_var_17798_16_non_const_dS, __cuda_local_var_17796_16_non_const_J, __cuda_local_var_17801_9_non_const_c, __cuda_local_var_17795_15_non_const_cols, __cuda_local_var_17795_9_non_const_rows, __cuda_local_var_17796_19_non_const_lambda, __cuda_local_var_17796_27_non_const_q0sqr));
...
free(((void *)__cuda_local_var_17798_12_non_const_dN)); free(((void *)__cuda_local_var_17798_16_non_const_dS)); free(((void *)__cuda_local_var_17798_20_non_const_dW)); free(((void *)__cuda_local_var_17798_24_non_const_dE));
# 287 "srad.cu"
free(((void *)__cuda_local_var_17801_9_non_const_c)); 
