...
# 36
__attribute__((unused)) static float temp[16][16]; 
# 37
__attribute__((unused)) static float temp_result[16][16]; 
# 39
__attribute__((unused)) static float north[16][16]; 
# 40
__attribute__((unused)) static float south[16][16]; 
# 41
__attribute__((unused)) static float east[16][16]; 
# 42
__attribute__((unused)) static float west[16][16]; 
# 47
if (by == 0) { 
# 48
(((north)[ty])[tx]) = (J_cuda[(16 * bx) + tx]); 
# 49
...
# 53
(((south)[ty])[tx]) = (J_cuda[((((cols * 16) * ((gridDim.y) - (1))) + (16 * bx)) + (cols * (16 - 1))) + tx]); 
# 54
} else { 
# 55
(((north)[ty])[tx]) = (J_cuda[index_n]); 
...
# 65
(((west)[ty])[tx]) = (J_cuda[((cols * 16) * by) + (cols * ty)]); 
# 66
} else { 
# 67
if (bx == ((gridDim.x) - (1))) { 
...
# 69
(((east)[ty])[tx]) = (J_cuda[(((((cols * 16) * by) + ((16) * ((gridDim.x) - (1)))) + (cols * ty)) + (16)) - (1)]); 
# 70
} else { 
# 71
(((west)[ty])[tx]) = (J_cuda[index_w]); 
...
c = ((1.0) / ((1.0) + den)); 
# 155
if (c < (0)) { (((temp_result)[ty])[tx]) = (0); } else { 
# 156
if (c > (1)) { (((temp_result)[ty])[tx]) = (1); } else 
# 157
{ (((temp_result)[ty])[tx]) = c; }  }  
# 159
__syncthreads(); 
...
# 198
__attribute__((unused)) static float south_c[16][16]; 
# 199
__attribute__((unused)) static float east_c[16][16]; 
# 201
__attribute__((unused)) static float c_cuda_temp[16][16]; 
# 202
__attribute__((unused)) static float c_cuda_result[16][16]; 
# 203
__attribute__((unused)) static float temp[16][16]; 
# 206
(((temp)[ty])[tx]) = (J_cuda[index]); 
...
if (by == ((gridDim.y) - (1))) { 
# 213
(((south_c)[ty])[tx]) = (C_cuda[((((cols * 16) * ((gridDim.y) - (1))) + (16 * bx)) + (cols * (16 - 1))) + tx]); 
# 214
} else { 
# 215
...
if (bx == ((gridDim.x) - (1))) { 
# 223
(((east_c)[ty])[tx]) = (C_cuda[(((((cols * 16) * by) + ((16) * ((gridDim.x) - (1)))) + (cols * ty)) + (16)) - (1)]); 
# 224
} else { 
# 225
...
# 244
cudaConfigureCall(dimGrid, dimBlock) ? ((void)0) : srad_cuda_1(dE, dW, dN, dS, J, c, cols, rows, q0sqr); 
# 245
cudaConfigureCall(dimGrid, dimBlock) ? ((void)0) : srad_cuda_2(dE, dW, dN, dS, J, c, cols, rows, lambda, q0sqr); 
# 246
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__12_srad_cpp4_ii_73102f0c
# 1 "srad.cudafe1.stub.c"
