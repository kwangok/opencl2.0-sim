...
# 7 "kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z6kernel20params_common_change13params_commonP13params_unique(params_common_change, params_common, params_unique *);
...
# 9 "kernel.cu" 2
# 7 "kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z6kernel20params_common_change13params_commonP13params_unique(
# 7 "kernel.cu"
...
# 52 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20076_32_non_const_in_partial_sum[51];
# 53 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20077_32_non_const_in_sqr_partial_sum[51];
# 54 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20078_32_non_const_in_final_sum;
# 55 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20079_32_non_const_in_sqr_final_sum;
# 56 "kernel.cu"
...
# 60 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20084_32_non_const_denomT;
# 61 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20085_32_non_const_par_max_val[131];
# 62 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) int __cuda_local_var_20086_30_non_const_par_max_coo[131];
# 63 "kernel.cu"
 int __cuda_local_var_20087_6_non_const_pointer;
# 64 "kernel.cu"
static __attribute__((__used__)) __attribute__((shared)) float __cuda_local_var_20088_32_non_const_d_in_mod_temp[2601];
# 65 "kernel.cu"
...
# 902 "kernel.cu"
__cuda_local_var_20061_8_non_const_temp2 = ((((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_in2_sqr_sub2)[__cuda_local_var_20098_6_non_const_ei_new]) - ((float)(fdividef(((double)(__cuda_local_var_20060_8_non_const_temp * __cuda_local_var_20060_8_non_const_temp)), ((double)((float)(d_common.in_elem)))))));
# 903 "kernel.cu"
...
# 906 "kernel.cu"
(((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_in2_sqr_sub2)[__cuda_local_var_20098_6_non_const_ei_new]) = ((float)(sqrtf(((double)__cuda_local_var_20061_8_non_const_temp2))));
# 910 "kernel.cu"
__cuda_local_var_20098_6_non_const_ei_new = (__cuda_local_var_20098_6_non_const_ei_new + 512);
# 912 "kernel.cu"
}
...
# 1025 "kernel.cu"
 float __T22;
# 1027 "kernel.cu"
__cuda_local_var_20080_8_non_const_mean = ((float)(fdividef(((double)__cuda_local_var_20078_32_non_const_in_final_sum), ((double)((float)(d_common.in_elem))))));
# 1028 "kernel.cu"
...
# 1029 "kernel.cu"
__cuda_local_var_20082_8_non_const_variance = (((float)(fdividef(((double)__cuda_local_var_20079_32_non_const_in_sqr_final_sum), ((double)((float)(d_common.in_elem)))))) - __cuda_local_var_20081_8_non_const_mean_sqr);
# 1030 "kernel.cu"
__cuda_local_var_20083_8_non_const_deviation = ((float)(sqrtf(((double)__cuda_local_var_20082_8_non_const_variance))));
# 1032 "kernel.cu"
__cuda_local_var_20084_32_non_const_denomT = (((float)((__T22 = ((float)((d_common.in_elem) - 1))) , (sqrtf(((double)__T22))))) * __cuda_local_var_20083_8_non_const_deviation);
# 1034 "kernel.cu"
}
# 1040 "kernel.cu"
__syncthreads();
...
{
# 1071 "kernel.cu"
(((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_conv)[__cuda_local_var_20098_6_non_const_ei_new]) = ((((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_conv)[__cuda_local_var_20098_6_non_const_ei_new]) - ((float)(fdividef(((double)((((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_in2_sub2)[__cuda_local_var_20098_6_non_const_ei_new]) * __cuda_local_var_20078_32_non_const_in_final_sum)), ((double)((float)(d_common.in_elem)))))));
# 1074 "kernel.cu"
__cuda_local_var_20098_6_non_const_ei_new = (__cuda_local_var_20098_6_non_const_ei_new + 512);
# 1076 "kernel.cu"
}
...
{
# 1092 "kernel.cu"
(((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_in2_sqr_sub2)[__cuda_local_var_20098_6_non_const_ei_new]) = ((float)(fdividef(((double)(((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_conv)[__cuda_local_var_20098_6_non_const_ei_new])), ((double)(((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_in2_sqr_sub2)[__cuda_local_var_20098_6_non_const_ei_new])))));
# 1095 "kernel.cu"
__cuda_local_var_20098_6_non_const_ei_new = (__cuda_local_var_20098_6_non_const_ei_new + 512);
# 1097 "kernel.cu"
}
...
# 1230 "kernel.cu"
__cuda_local_var_20066_8_non_const_largest_value_current = ((float)((__T21 = (((d_unique[__cuda_local_var_20096_6_non_const_bx]).d_mask_conv)[__cuda_local_var_20068_6_non_const_largest_coordinate_current])) , (fabsf(((double)__T21)))));
# 1231 "kernel.cu"
