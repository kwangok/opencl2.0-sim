...
# 154
timespec st_ctim; 
# 167 "/usr/include/x86_64-linux-gnu/bits/stat.h" 3
long __unused[3]; 
# 171
}; }
# 211 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3
extern "C" { extern __attribute((gnu_inline)) inline int stat(const char *__restrict__ , struct stat *__restrict__ ) throw()
# 212
 __attribute((__nonnull__(1, 2))); } 
# 216
extern "C" { extern __attribute((gnu_inline)) inline int fstat(int , struct stat * ) throw() __attribute((__nonnull__(2))); } 
# 230 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3
extern "C" { extern __attribute((gnu_inline)) inline int stat64(const char *__restrict__ , struct stat64 *__restrict__ ) throw()
# 231
 __attribute((__nonnull__(1, 2))); } 
# 232
extern "C" { extern __attribute((gnu_inline)) inline int fstat64(int , struct stat64 * ) throw() __attribute((__nonnull__(2))); } 
# 240
extern "C" { extern __attribute((gnu_inline)) inline int fstatat(int , const char *__restrict__ , struct stat *__restrict__ , int ) throw()
# 242
 __attribute((__nonnull__(2, 3))); } 
# 255 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3
extern "C" { extern __attribute((gnu_inline)) inline int fstatat64(int , const char *__restrict__ , struct stat64 *__restrict__ , int ) throw()
# 257
 __attribute((__nonnull__(2, 3))); } 
# 265
extern "C" { extern __attribute((gnu_inline)) inline int lstat(const char *__restrict__ , struct stat *__restrict__ ) throw()
# 266
 __attribute((__nonnull__(1, 2))); } 
# 278 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3
extern "C" { extern __attribute((gnu_inline)) inline int lstat64(const char *__restrict__ , struct stat64 *__restrict__ ) throw()
# 280
 __attribute((__nonnull__(1, 2))); } 
# 286
...
# 331
 __attribute((__nonnull__(2))); 
# 338
extern "C" { extern __attribute((gnu_inline)) inline int mknod(const char * , __mode_t , __dev_t ) throw()
# 339
 __attribute((__nonnull__(1))); } 
# 345
extern "C" { extern __attribute((gnu_inline)) inline int mknodat(int , const char * , __mode_t , __dev_t ) throw()
# 346
 __attribute((__nonnull__(2))); } 
# 352
...
# 409
 __attribute((__nonnull__(3, 4))); 
# 434 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3
...
# 167 "/usr/include/x86_64-linux-gnu/bits/fcntl.h" 3
...
# 272 "/usr/include/x86_64-linux-gnu/bits/fcntl.h" 3
...
# 307 "/usr/include/x86_64-linux-gnu/bits/fcntl.h" 3
...
# 302
 __attribute((const)); 
# 305
extern "C" { extern __attribute((gnu_inline)) inline intmax_t strtoimax(const char *__restrict__ , char **__restrict__ , int ) throw(); } 
# 309
extern "C" { extern __attribute((gnu_inline)) inline uintmax_t strtoumax(const char *__restrict__ , char **__restrict__ , int ) throw(); } 
# 313
extern "C" { extern __attribute((gnu_inline)) inline intmax_t wcstoimax(const wchar_t *__restrict__ , wchar_t **__restrict__ , int ) throw(); } 
# 318
extern "C" { extern __attribute((gnu_inline)) inline uintmax_t wcstoumax(const wchar_t *__restrict__ , wchar_t **__restrict__ , int ) throw(); } 
# 326
...
extern "C" { 
# 331
__attribute((__gnu_inline__)) inline intmax_t 
# 332
strtoimax(const char *__restrict__ nptr, char **__restrict__ endptr, int base) throw() 
# 334
{ 
# 335
...
extern "C" { 
# 344
__attribute((__gnu_inline__)) inline uintmax_t 
# 345
strtoumax(const char *__restrict__ nptr, char **__restrict__ endptr, int base) throw() 
# 347
{ 
# 348
...
__attribute((__gnu_inline__)) inline intmax_t 
# 357
wcstoimax(const wchar_t *__restrict__ nptr, wchar_t **__restrict__ endptr, int base) throw() 
# 359
{ 
# 360
...
__attribute((__gnu_inline__)) inline uintmax_t 
# 371
wcstoumax(const wchar_t *__restrict__ nptr, wchar_t **__restrict__ endptr, int base) throw() 
# 373
{ 
# 374
...
# 7 "kernel.cu"
void kernel(params_common_change d_common_change, params_common d_common, params_unique d_unique[51]) ;
#if 0
# 7
{ 
# 13
...
int offset_col; 
# 52
__attribute__((unused)) static float in_partial_sum[51]; 
# 53
__attribute__((unused)) static float in_sqr_partial_sum[51]; 
# 54
__attribute__((unused)) static float in_final_sum; 
# 55
__attribute__((unused)) static float in_sqr_final_sum; 
# 56
float mean; 
# 57
float mean_sqr; 
...
float deviation; 
# 60
__attribute__((unused)) static float denomT; 
# 61
__attribute__((unused)) static float par_max_val[131]; 
# 62
__attribute__((unused)) static int par_max_coo[131]; 
# 63
int pointer; 
# 64
__attribute__((unused)) static float d_in_mod_temp[2601]; 
# 65
int ori_pointer; 
# 66
int loc_pointer; 
...
ori_pointer = ((ori_col * (d_common.frame_rows)) + ori_row); 
# 1324
(d_in[ei_new]) = (((d_common.alpha) * (d_in[ei_new])) + (((1.0) - (d_common.alpha)) * ((d_common_change.d_frame)[ori_pointer]))); 
# 1327
ei_new = (ei_new + 512); 
# 1329
}  
...
# 602
cudaConfigureCall(blocks, threads) ? ((void)0) : kernel(common_change, common, unique); 
# 605
free(frame); 
# 608
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__12_main_cpp4_ii_8fb32601
# 1 "main.cudafe1.stub.c"
