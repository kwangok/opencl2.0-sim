...
static void __sti___12_main_cpp1_ii_8fb32601(void) __attribute__((__constructor__));
# 34 "main.cu"
...
# 599 "main.cu"
(common_change.d_frame) = __cuda_local_var_21267_9_non_const_frame;


(cudaConfigureCall(__cuda_local_var_21258_7_non_const_blocks, __cuda_local_var_21257_7_non_const_threads, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z6kernel20params_common_change13params_commonP13params_unique(common_change, common, unique));
...
static void __sti___12_main_cpp1_ii_8fb32601(void) {   }
