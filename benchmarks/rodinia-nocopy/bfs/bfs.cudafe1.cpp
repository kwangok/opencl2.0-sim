...
stop = false; 
# 203
cudaConfigureCall(grid, threads, 0) ? ((void)0) : Kernel(h_graph_nodes, h_graph_edges, h_graph_mask, h_updating_graph_mask, h_graph_visited, h_cost, no_of_nodes); 
# 206
cudaThreadSynchronize(); 
# 208
cudaConfigureCall(grid, threads, 0) ? ((void)0) : Kernel2(h_graph_mask, h_updating_graph_mask, h_graph_visited, &stop, no_of_nodes); 
# 210
cudaThreadSynchronize(); 
# 211
k++; 
