...
# 112 "pathfinder.cu"
__attribute__((global)) extern void _Z14dynproc_kerneliPiS_S_iiii(int, int *, int *, int *, int, int, int, int);
...
# 114 "pathfinder.cu" 2
# 112 "pathfinder.cu"
__attribute__((global)) void _Z14dynproc_kerneliPiS_S_iiii(
# 113 "pathfinder.cu"
int iteration,
# 114 "pathfinder.cu"
int *gpuWall,
...
{
# 123 "pathfinder.cu"
 __attribute__((shared)) int __cuda_local_var_16465_37_non_const_prev[256];
# 124 "pathfinder.cu"
 __attribute__((shared)) int __cuda_local_var_16466_37_non_const_result[256];
# 126 "pathfinder.cu"
