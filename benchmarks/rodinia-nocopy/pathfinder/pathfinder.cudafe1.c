...
# 196 "pathfinder.cu"
extern int _Z9calc_pathPiPS_iiiii(int *, int **, int, int, int, int, int);
# 216 "pathfinder.cu"
...
static void __sti___18_pathfinder_cpp1_ii_2e3c706b(void) __attribute__((__constructor__));
...
{  const char *__T20;
 ...
 const char *__T22;
# 60 "pathfinder.cu"
 int __cuda_local_var_16402_6_non_const_seed;
# 36 "pathfinder.cu"
if (argc == 4) {

cols = ((__T20 = ((const char *)(argv[1]))) , ((int)(strtol(__T20, ((char **)0LL), 10))));

rows = ((__T21 = ((const char *)(argv[2]))) , ((int)(strtol(__T21, ((char **)0LL), 10))));

pyramid_height = ((__T22 = ((const char *)(argv[3]))) , ((int)(strtol(__T22, ((char **)0LL), 10))));
} else  {
printf(((const char *)"Usage: dynproc row_len col_len pyramid_height\n"));
exit(0);
}
data = ((int *)(_Znam((((unsigned long)(rows * cols)) * 4UL))));
data1 = ((int *)(_Znam((((unsigned long)(rows * cols)) * 4UL))));

wall = ((int **)(_Znam((((unsigned long)rows) * 8UL)))); {
...
result = ((int *)(_Znam((((unsigned long)cols) * 4UL))));



__cuda_local_var_16402_6_non_const_seed = 9;

srand(((unsigned)__cuda_local_var_16402_6_non_const_seed)); {
...
# 196 "pathfinder.cu"
int _Z9calc_pathPiPS_iiiii( int *gpuWall,  int **gpuResult,  int rows,  int cols,  int pyramid_height,  int blockCols,  int borderCols)

{  unsigned __T23;
 dim3 __cuda_local_var_16541_14_non_const_dimBlock;
 dim3 __cuda_local_var_16542_14_non_const_dimGrid;

 int __cuda_local_var_16544_13_non_const_src;
# 202 "pathfinder.cu"
 int __cuda_local_var_16544_22_non_const_dst;
# 199 "pathfinder.cu"
{ (__cuda_local_var_16541_14_non_const_dimBlock.x) = 256U; (__cuda_local_var_16541_14_non_const_dimBlock.y) = 1U; (__cuda_local_var_16541_14_non_const_dimBlock.z) = 1U; }
{ __T23 = ((unsigned)blockCols); { (__cuda_local_var_16542_14_non_const_dimGrid.x) = __T23; (__cuda_local_var_16542_14_non_const_dimGrid.y) = 1U; (__cuda_local_var_16542_14_non_const_dimGrid.z) = 1U; } }

__cuda_local_var_16544_13_non_const_src = 1; __cuda_local_var_16544_22_non_const_dst = 0; {
 int t;
# 203 "pathfinder.cu"
t = 0; for (; (t < (rows - 1)); t += pyramid_height) {
 int __cuda_local_var_16546_17_non_const_temp;
# 204 "pathfinder.cu"
__cuda_local_var_16546_17_non_const_temp = __cuda_local_var_16544_13_non_const_src;
__cuda_local_var_16544_13_non_const_src = __cuda_local_var_16544_22_non_const_dst;
__cuda_local_var_16544_22_non_const_dst = __cuda_local_var_16546_17_non_const_temp;
(cudaConfigureCall(__cuda_local_var_16542_14_non_const_dimGrid, __cuda_local_var_16541_14_non_const_dimBlock, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z14dynproc_kerneliPiS_S_iiii(((pyramid_height <= ((rows - t) - 1)) ? pyramid_height : ((rows - t) - 1)), gpuWall, (gpuResult[__cuda_local_var_16544_13_non_const_src]), (gpuResult[__cuda_local_var_16544_22_non_const_dst]), cols, rows, t, borderCols));



cudaThreadSynchronize();
} }
return __cuda_local_var_16544_22_non_const_dst;
}

int main( int argc,  char **argv)
{
 int __cuda_local_var_16560_9_non_const_num_devices;
cudaGetDeviceCount((&__cuda_local_var_16560_9_non_const_num_devices));
if (__cuda_local_var_16560_9_non_const_num_devices > 1) { cudaSetDevice(0); }
...
void _Z3runiPPc( int argc,  char **argv)
{
 ...
 int __cuda_local_var_16574_9_non_const_borderCols;
 int __cuda_local_var_16575_9_non_const_smallBlockCol;
 int __cuda_local_var_16576_9_non_const_blockCols;




 int *__cuda_local_var_16581_20_non_const_gpuResult[2];
 int __cuda_local_var_16582_9_non_const_size;
# 252 "pathfinder.cu"
 int __cuda_local_var_16594_9_non_const_final_ret;
# 229 "pathfinder.cu"
_Z4initiPPc(argc, argv);


__cuda_local_var_16574_9_non_const_borderCols = (pyramid_height * 1);
__cuda_local_var_16575_9_non_const_smallBlockCol = (256 - ((pyramid_height * 1) * 2));
__cuda_local_var_16576_9_non_const_blockCols = ((cols / __cuda_local_var_16575_9_non_const_smallBlockCol) + (((cols % __cuda_local_var_16575_9_non_const_smallBlockCol) == 0) ? 0 : 1));

printf(((const char *)"pyramidHeight: %d\ngridSize: [%d]\nborder:[%d]\nblockSize: %d\nblockGrid:[%d]\ntargetBlock:[%d]\n"), pyramid_height, cols, __cuda_local_var_16574_9_non_const_borderCols, 256, __cuda_local_var_16576_9_non_const_blockCols, __cuda_local_var_16575_9_non_const_smallBlockCol);



__cuda_local_var_16582_9_non_const_size = (rows * cols);
# 247 "pathfinder.cu"
((__cuda_local_var_16581_20_non_const_gpuResult)[0]) = data;
((__cuda_local_var_16581_20_non_const_gpuResult)[1]) = data1;

m5_work_begin(0UL, 0UL);

__cuda_local_var_16594_9_non_const_final_ret = (_Z9calc_pathPiPS_iiiii((data + cols), (__cuda_local_var_16581_20_non_const_gpuResult), rows, cols, pyramid_height, __cuda_local_var_16576_9_non_const_blockCols, __cuda_local_var_16574_9_non_const_borderCols));
...
result = ((__cuda_local_var_16581_20_non_const_gpuResult)[__cuda_local_var_16594_9_non_const_final_ret]); {
...
static void __sti___18_pathfinder_cpp1_ii_2e3c706b(void) {   }

#include "pathfinder.cudafe1.stub.c"
