...
# 46
__attribute__((unused)) static int temp[16 + 1][16 + 1]; 
# 47
__attribute__((unused)) static int ref[16][16]; 
# 49
if (tx == 0) { 
# 50
...
(dimGrid.y) = (1); 
# 168
cudaConfigureCall(dimGrid, dimBlock) ? ((void)0) : needle_cuda_shared_1(referrence, input_itemsets, output_itemsets, max_cols, penalty, i, block_width); 
# 170
...
(dimGrid.y) = (1); 
# 177
cudaConfigureCall(dimGrid, dimBlock) ? ((void)0) : needle_cuda_shared_2(referrence, input_itemsets, output_itemsets, max_cols, penalty, i, block_width); 
# 179
cudaThreadSynchronize(); 
# 180
}  
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_needle_cpp4_ii_734a7458
# 1 "needle.cudafe1.stub.c"
