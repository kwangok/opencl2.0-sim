...
double _Z7gettimev(void) {
 struct timeval __cuda_local_var_17753_18_non_const_t;
gettimeofday((&__cuda_local_var_17753_18_non_const_t), ((struct timezone *)0LL));
return ((double)(__cuda_local_var_17753_18_non_const_t.tv_sec)) + (((double)(__cuda_local_var_17753_18_non_const_t.tv_usec)) * (9.999999999999999547e-07));
}
# 60 "backprop_cuda.cu"
...
{  unsigned __T20;
 int __cuda_local_var_17774_7_non_const_in;
# 69 "backprop_cuda.cu"
 int __cuda_local_var_17774_11_non_const_hid;
# 69 "backprop_cuda.cu"
 int __cuda_local_var_17774_16_non_const_out;
 float __cuda_local_var_17775_9_non_const_out_err;
# 70 "backprop_cuda.cu"
 float __cuda_local_var_17775_18_non_const_hid_err;
# 77 "backprop_cuda.cu"
 int __cuda_local_var_17782_7_non_const_m;



 float *__cuda_local_var_17786_10_non_const_partial_sum;



 float __cuda_local_var_17790_9_non_const_sum;
 float *__cuda_local_var_17791_10_non_const_input_weights_one_dim;
 float *__cuda_local_var_17792_10_non_const_input_weights_prev_one_dim;

 dim3 __cuda_local_var_17794_8_non_const_grid;
 dim3 __cuda_local_var_17795_8_non_const_threads;
# 144 "backprop_cuda.cu"
 cudaError_t __cuda_local_var_17823_15_non_const_error;
# 72 "backprop_cuda.cu"
__cuda_local_var_17774_7_non_const_in = (net->input_n);
__cuda_local_var_17774_11_non_const_hid = (net->hidden_n);
__cuda_local_var_17774_16_non_const_out = (net->output_n);


__cuda_local_var_17782_7_non_const_m = 0;
# 88 "backprop_cuda.cu"
num_blocks = ((unsigned)(__cuda_local_var_17774_7_non_const_in / 16));
{ __T20 = num_blocks; { (__cuda_local_var_17794_8_non_const_grid.x) = 1U; (__cuda_local_var_17794_8_non_const_grid.y) = __T20; (__cuda_local_var_17794_8_non_const_grid.z) = 1U; } }
{ (__cuda_local_var_17795_8_non_const_threads.x) = 16U; (__cuda_local_var_17795_8_non_const_threads.y) = 16U; (__cuda_local_var_17795_8_non_const_threads.z) = 1U; }

__cuda_local_var_17791_10_non_const_input_weights_one_dim = ((float *)(malloc((((unsigned long)((__cuda_local_var_17774_7_non_const_in + 1) * (__cuda_local_var_17774_11_non_const_hid + 1))) * 4UL))));
__cuda_local_var_17792_10_non_const_input_weights_prev_one_dim = ((float *)(malloc((((unsigned long)((__cuda_local_var_17774_7_non_const_in + 1) * (__cuda_local_var_17774_11_non_const_hid + 1))) * 4UL))));
__cuda_local_var_17786_10_non_const_partial_sum = ((float *)(malloc((((unsigned long)(num_blocks * 16U)) * 4UL)))); {


 int k;
# 97 "backprop_cuda.cu"
k = 0; for (; (k <= __cuda_local_var_17774_7_non_const_in); k++) { {
 int j;
# 98 "backprop_cuda.cu"
j = 0; for (; (j <= __cuda_local_var_17774_11_non_const_hid); j++) {
(__cuda_local_var_17791_10_non_const_input_weights_one_dim[__cuda_local_var_17782_7_non_const_m]) = (((net->input_weights)[k])[j]);
(__cuda_local_var_17792_10_non_const_input_weights_prev_one_dim[__cuda_local_var_17782_7_non_const_m]) = (((net->input_prev_weights)[k])[j]);
__cuda_local_var_17782_7_non_const_m++;
} }
} }
...
(cudaConfigureCall(__cuda_local_var_17794_8_non_const_grid, __cuda_local_var_17795_8_non_const_threads, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z22bpnn_layerforward_CUDAPfS_S_S_ii((net->input_units), ((float *)0LL), __cuda_local_var_17791_10_non_const_input_weights_one_dim, __cuda_local_var_17786_10_non_const_partial_sum, __cuda_local_var_17774_7_non_const_in, __cuda_local_var_17774_11_non_const_hid));
# 142 "backprop_cuda.cu"
cudaThreadSynchronize();

__cuda_local_var_17823_15_non_const_error = (cudaGetLastError());
if (((int)__cuda_local_var_17823_15_non_const_error) != 0) {
printf(((const char *)"bpnn kernel error: %s\n"), (cudaGetErrorString(__cuda_local_var_17823_15_non_const_error)));
exit(1);
} {  float __T21;
...
j = 1; for (; (j <= __cuda_local_var_17774_11_non_const_hid); j++) {
__cuda_local_var_17790_9_non_const_sum = (0.0F); {
 int k;
# 154 "backprop_cuda.cu"
k = 0; for (; (((unsigned)k) < num_blocks); k++) {
__cuda_local_var_17790_9_non_const_sum += (__cuda_local_var_17786_10_non_const_partial_sum[(((k * __cuda_local_var_17774_11_non_const_hid) + j) - 1)]);
} }
__cuda_local_var_17790_9_non_const_sum += (((net->input_weights)[0])[j]);
((net->hidden_units)[j]) = ((float)((1.0) / ((1.0) + ((double)((__T21 = (-__cuda_local_var_17790_9_non_const_sum)) , (__builtin_expf(__T21)))))));
} }


bpnn_layerforward((net->hidden_units), (net->output_units), (net->hidden_weights), __cuda_local_var_17774_11_non_const_hid, __cuda_local_var_17774_16_non_const_out);
bpnn_output_error((net->output_delta), (net->target), (net->output_units), __cuda_local_var_17774_16_non_const_out, (&__cuda_local_var_17775_9_non_const_out_err));
bpnn_hidden_error((net->hidden_delta), __cuda_local_var_17774_11_non_const_hid, (net->output_delta), __cuda_local_var_17774_16_non_const_out, (net->hidden_weights), (net->hidden_units), (&__cuda_local_var_17775_18_non_const_hid_err));
bpnn_adjust_weights((net->output_delta), __cuda_local_var_17774_16_non_const_out, (net->hidden_units), __cuda_local_var_17774_11_non_const_hid, (net->hidden_weights), (net->hidden_prev_weights));
# 184 "backprop_cuda.cu"
(cudaConfigureCall(__cuda_local_var_17794_8_non_const_grid, __cuda_local_var_17795_8_non_const_threads, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z24bpnn_adjust_weights_cudaPfiS_iS_S_((net->hidden_delta), __cuda_local_var_17774_11_non_const_hid, (net->input_units), __cuda_local_var_17774_7_non_const_in, __cuda_local_var_17791_10_non_const_input_weights_one_dim, __cuda_local_var_17792_10_non_const_input_weights_prev_one_dim));
...
k = 0; for (; (((unsigned)k) < num_blocks); k++) {
printf(((const char *)"%f "), ((double)(__cuda_local_var_17786_10_non_const_partial_sum[(((k * __cuda_local_var_17774_11_non_const_hid) + j) - 1)])));
} }
printf(((const char *)"\n"));
} }
printf(((const char *)"\n"));
...
j = 0; for (; (j <= __cuda_local_var_17774_11_non_const_hid); j++) {
printf(((const char *)"%f "), ((double)(__cuda_local_var_17791_10_non_const_input_weights_one_dim[(__cuda_local_var_17782_7_non_const_m++)])));
} }
} }
printf(((const char *)"\n"));
...
free(((void *)__cuda_local_var_17786_10_non_const_partial_sum));
free(((void *)__cuda_local_var_17791_10_non_const_input_weights_one_dim));
free(((void *)__cuda_local_var_17792_10_non_const_input_weights_prev_one_dim)); 
