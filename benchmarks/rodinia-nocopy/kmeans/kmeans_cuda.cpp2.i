...
enum omp_sched_t {
# 49 "/usr/lib/gcc/x86_64-linux-gnu/4.4.7/include/omp.h" 3
omp_sched_static = 1,
# 50 "/usr/lib/gcc/x86_64-linux-gnu/4.4.7/include/omp.h" 3
omp_sched_dynamic,
# 51 "/usr/lib/gcc/x86_64-linux-gnu/4.4.7/include/omp.h" 3
omp_sched_guided,
# 52 "/usr/lib/gcc/x86_64-linux-gnu/4.4.7/include/omp.h" 3
omp_sched_auto};
...
__attribute__((global)) extern void _Z14invert_mappingPfS_ii(float *, float *, int, int);
# 58 "./kmeans_cuda_kernel.cu"
__attribute__((global)) extern void _Z11kmeansPointPfiiiPiS_S_S0_(float *, int, int, int, int *, float *, float *, int *);
...
# 34 "./kmeans_cuda_kernel.cu"
__attribute__((global)) void _Z14invert_mappingPfS_ii(
# 34 "./kmeans_cuda_kernel.cu"
float *input,
...
# 58 "./kmeans_cuda_kernel.cu"
__attribute__((global)) void _Z11kmeansPointPfiiiPiS_S_S0_(
# 58 "./kmeans_cuda_kernel.cu"
float *features,
