...
# 75
cudaConfigureCall(num_blocks, num_threads) ? ((void)0) : invert_mapping(features[0], feature_d, npoints, nfeatures); 
# 97 "kmeans_cuda.cu"
} 
# 103
...
# 200
cudaConfigureCall(grid, threads) ? ((void)0) : kmeansPoint(feature_d, nfeatures, npoints, nclusters, membership_new, clusters[0], 0, 0); 
# 209
