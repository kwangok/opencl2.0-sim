...
__attribute__((global)) __attribute__((__used__)) extern void _Z14invert_mappingPfS_ii(float *, float *, int, int);
# 58 "./kmeans_cuda_kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z11kmeansPointPfiiiPiS_S_S0_(float *, int, int, int, int *, float *, float *, int *);
...
# 60 "./kmeans_cuda_kernel.cu" 2
# 34 "./kmeans_cuda_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z14invert_mappingPfS_ii(
# 34 "./kmeans_cuda_kernel.cu"
float *input,
...
# 58 "./kmeans_cuda_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z11kmeansPointPfiiiPiS_S_S0_(
# 58 "./kmeans_cuda_kernel.cu"
float *features,
