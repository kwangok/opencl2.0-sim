...
//	static LBM_GridPtr CUDA_srcGrid;
...
//	CUDA_LBM_initializeGrid( (float**)&CUDA_srcGrid, (float**)&CUDA_srcGrid );
//	CUDA_LBM_initializeGrid( (float**)&CUDA_dstGrid, (float**)&CUDA_dstGrid );
...
//	LBM_Grid CUDA_srcGrid;

	//Setup TEMP datastructures
//	LBM_allocateGrid( (float**) &CUDA_srcGrid );

        pb_SwitchToTimer(&timers, pb_TimerID_COPY);
//	CUDA_LBM_getDeviceGrid((float**)&CUDA_srcGrid, (float**)&CUDA_srcGrid);
